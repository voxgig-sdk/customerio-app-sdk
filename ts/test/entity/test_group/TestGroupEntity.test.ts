...
describe('TestGroupEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of []) {
      if (!live && maybeSkipControl(t, 'entityOp', 'test_group.' + op, live)) return
    }
    ...
    let test_group_ref01_data = Object.values(setup.data.existing.test_group)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/test_group/TestGroupTestData.json')
