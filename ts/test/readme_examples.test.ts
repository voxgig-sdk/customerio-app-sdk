...
const SDK_NAME = 'CustomerioAppSDK'
...
const TEST_SEED = {"entity":{"action":{"test01":{"id":"test01"}},"activity":{"test01":{"id":"test01"}},"asset":{"test01":{"id":"test01"}},"attribute":{"test01":{"id":"test01"}},"automation":{"test01":{"id":"test01"}},"broadcast":{"test01":{"id":"test01"}},"campaign":{"test01":{"id":"test01"}},"collection":{"test01":{"id":"test01"}},"content":{"test01":{"id":"test01"}},"customer":{"test01":{"id":"test01"}},"data_index":{"test01":{"id":"test01"}},"delivery":{"test01":{"id":"test01"}},"design_studio":{"test01":{"id":"test01"}},"design_studio_email":{"test01":{"id":"test01"}},"email":{"test01":{"id":"test01"}},"end":{"test01":{"id":"test01"}},"esp_suppression":{"test01":{"id":"test01"}},"export":{"test01":{"id":"test01"}},"import":{"test01":{"id":"test01"}},"in_app":{"test01":{"id":"test01"}},"inbox_message":{"test01":{"id":"test01"}},"info":{"test01":{"id":"test01"}},"ip_address":{"test01":{"id":"test01"}},"language":{"test01":{"id":"test01"}},"link":{"test01":{"id":"test01"}},"live_notification":{"test01":{"id":"test01"}},"message":{"test01":{"id":"test01"}},"newsletter":{"test01":{"id":"test01"}},"newsletter_metric":{"test01":{"id":"test01"}},"newsletter_variant":{"test01":{"id":"test01"}},"object":{"test01":{"id":"test01"}},"object_type":{"test01":{"id":"test01"}},"opt_out":{"test01":{"id":"test01"}},"push":{"test01":{"id":"test01"}},"relationship":{"test01":{"id":"test01"}},"reporting_webhook":{"test01":{"id":"test01"}},"search_suppression":{"test01":{"id":"test01"}},"segment":{"test01":{"id":"test01"}},"send_message":{"test01":{"id":"test01"}},"sender_identity":{"test01":{"id":"test01"}},"sms":{"test01":{"id":"test01"}},"snippet":{"test01":{"id":"test01"}},"start":{"test01":{"id":"test01"}},"subscription_center":{"test01":{"id":"test01"}},"subscription_channel":{"test01":{"id":"test01"}},"subscription_topic":{"test01":{"id":"test01"}},"suppression":{"test01":{"id":"test01"}},"test_group":{"test01":{"id":"test01"}},"transactional":{"test01":{"id":"test01"}},"trigger":{"test01":{"id":"test01"}},"update":{"test01":{"id":"test01"}},"whatsapp":{"test01":{"id":"test01"}},"workspace":{"test01":{"id":"test01"}}}}
...
function isRunnable(code: string): boolean {
  return (
    /new\s+CustomerioAppSDK\b/.test(code) ||
    /\bCustomerioAppSDK\.test\b/.test(code) ||
    /\bclient\s*\./.test(code)
  )
}
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+CustomerioAppSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/CustomerioAppSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
