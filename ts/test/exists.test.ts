...
describe('exists', async () => {
  ...
  //
  // CustomerioAppSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof CustomerioAppSDK, true,
      'CustomerioAppSDK.test() must return a client synchronously')
  })
