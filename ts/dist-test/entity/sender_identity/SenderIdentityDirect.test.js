...
(0, node_test_1.describe)('SenderIdentityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sender_identity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sender_identity', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-sender_identity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-sender_identity', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_SENDER_IDENTITY_ENTID'];
...
//# sourceMappingURL=SenderIdentityDirect.test.js.map