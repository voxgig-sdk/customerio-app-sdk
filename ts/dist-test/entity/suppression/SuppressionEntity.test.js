...
(0, node_test_1.describe)('SuppressionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "suppression", "op": {}, "relations": { "ancestors": [["domain"], ["suppression"]] }, "key$": "suppression", "name__orig": "suppression", "Name": "Suppression", "name_": "suppression", "name-": "suppression", "NAME": "SUPPRESSION", "index$": 46 }, { "active": true, "entity": "suppression", "key$": "BasicSuppressionFlow", "kind": "basic", "name": "BasicSuppressionFlow", "param": {}, "step": [] }, 'Suppression');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['suppression01', 'suppression02', 'suppression03', 'domain01', 'domain02', 'domain03', 'suppression01', 'suppression02', 'suppression03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['CUSTOMERIO_APP_TEST_SUPPRESSION_ENTID'];
    const live = 'TRUE' === env.CUSTOMERIO_APP_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CUSTOMERIO_APP_TEST_SUPPRESSION_ENTID'];
