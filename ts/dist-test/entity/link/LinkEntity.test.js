...
(0, node_test_1.describe)('LinkEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "link", "op": {}, "relations": { "ancestors": [["broadcast"], ["campaign"], ["newsletter"], ["transactional"], ["broadcast", "action"], ["campaign", "action"], ["newsletter", "content"]] }, "key$": "link", "name__orig": "link", "Name": "Link", "name_": "link", "name-": "link", "NAME": "LINK", "index$": 24 }, { "active": true, "entity": "link", "key$": "BasicLinkFlow", "kind": "basic", "name": "BasicLinkFlow", "param": {}, "step": [] }, 'Link');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['link01', 'link02', 'link03', 'broadcast01', 'broadcast02', 'broadcast03', 'campaign01', 'campaign02', 'campaign03', 'newsletter01', 'newsletter02', 'newsletter03', 'transactional01', 'transactional02', 'transactional03', 'broadcast01', 'broadcast02', 'broadcast03', 'action01', 'action02', 'action03', 'campaign01', 'campaign02', 'campaign03', 'action01', 'action02', 'action03', 'newsletter01', 'newsletter02', 'newsletter03', 'content01', 'content02', 'content03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    idmap = env['CUSTOMERIO_APP_TEST_LINK_ENTID'];
    const live = 'TRUE' === env.CUSTOMERIO_APP_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CUSTOMERIO_APP_TEST_LINK_ENTID'];
