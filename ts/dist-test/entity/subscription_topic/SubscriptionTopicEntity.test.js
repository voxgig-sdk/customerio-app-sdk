...
(0, node_test_1.describe)('SubscriptionTopicEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscription_topic.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscription_topic/SubscriptionTopicTestData.json');
    ...
    let idmap = transform(['subscription_topic01', 'subscription_topic02', 'subscription_topic03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubscriptionTopicEntity.test.js.map