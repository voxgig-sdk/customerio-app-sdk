...
(0, node_test_1.describe)('InAppEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'in_app.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "in_app", "op": {}, "relations": { "ancestors": [] }, "key$": "in_app", "name__orig": "in_app", "Name": "InApp", "name_": "in_app", "name-": "in-app", "NAME": "IN_APP", "index$": 19 }, { "active": true, "entity": "in_app", "key$": "BasicInAppFlow", "kind": "basic", "name": "BasicInAppFlow", "param": {}, "step": [] }, 'InApp');
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/in_app/InAppTestData.json');
    ...
    let idmap = transform(['in_app01', 'in_app02', 'in_app03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=InAppEntity.test.js.map