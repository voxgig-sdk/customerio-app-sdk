...
(0, node_test_1.describe)('InboxMessageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'inbox_message.' + op, live))
                return;
        }
        ...
        let inbox_message_ref01_data = Object.values(setup.data.existing.inbox_message)[0];
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/inbox_message/InboxMessageTestData.json');
    ...
    let idmap = transform(['inbox_message01', 'inbox_message02', 'inbox_message03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=InboxMessageEntity.test.js.map