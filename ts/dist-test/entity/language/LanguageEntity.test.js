...
function basicSetup(extra) {
    ...
    let idmap = transform(['language01', 'language02', 'language03', 'newsletter01', 'newsletter02', 'newsletter03', 'transactional01', 'transactional02', 'transactional03', 'broadcast01', 'broadcast02', 'broadcast03', 'action01', 'action02', 'action03', 'campaign01', 'campaign02', 'campaign03', 'action01', 'action02', 'action03', 'newsletter01', 'newsletter02', 'newsletter03', 'test_group01', 'test_group02', 'test_group03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
