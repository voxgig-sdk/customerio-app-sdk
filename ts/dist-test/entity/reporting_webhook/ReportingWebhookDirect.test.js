...
(0, node_test_1.describe)('ReportingWebhookDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-reporting_webhook', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reporting_webhook', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-reporting_webhook', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-reporting_webhook', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_REPORTING_WEBHOOK_ENTID'];
...
//# sourceMappingURL=ReportingWebhookDirect.test.js.map