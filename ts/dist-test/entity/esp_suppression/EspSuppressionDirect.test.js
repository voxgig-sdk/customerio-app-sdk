...
(0, node_test_1.describe)('EspSuppressionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-esp_suppression', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-esp_suppression', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["domain_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_ESP_SUPPRESSION_ENTID'];
...
//# sourceMappingURL=EspSuppressionDirect.test.js.map