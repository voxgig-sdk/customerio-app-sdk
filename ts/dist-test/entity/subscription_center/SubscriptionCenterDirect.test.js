...
(0, node_test_1.describe)('SubscriptionCenterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-subscription_center', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscription_center', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-subscription_center', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subscription_center', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_SUBSCRIPTION_CENTER_ENTID'];
...
//# sourceMappingURL=SubscriptionCenterDirect.test.js.map