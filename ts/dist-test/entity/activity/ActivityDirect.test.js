...
(0, node_test_1.describe)('ActivityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-activity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-activity', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CUSTOMERIO_APP_TEST_ACTIVITY_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_ACTIVITY_ENTID'];
...
//# sourceMappingURL=ActivityDirect.test.js.map