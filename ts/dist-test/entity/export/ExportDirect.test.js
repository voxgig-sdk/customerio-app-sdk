...
(0, node_test_1.describe)('ExportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-export', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-export', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-export', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-export', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CUSTOMERIO_APP_TEST_EXPORT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_EXPORT_ENTID'];
...
//# sourceMappingURL=ExportDirect.test.js.map