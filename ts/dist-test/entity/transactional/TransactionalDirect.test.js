...
(0, node_test_1.describe)('TransactionalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-transactional', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-transactional', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['transactional01'],
                },
            });
    ...
    (0, node_test_1.test)('direct-list-transactional', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-transactional', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["transactional01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_TRANSACTIONAL_ENTID'];
...
//# sourceMappingURL=TransactionalDirect.test.js.map