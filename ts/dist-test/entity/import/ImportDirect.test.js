...
(0, node_test_1.describe)('ImportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-import', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-import', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_IMPORT_ENTID'];
...
//# sourceMappingURL=ImportDirect.test.js.map