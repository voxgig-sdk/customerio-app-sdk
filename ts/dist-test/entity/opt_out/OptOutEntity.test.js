...
(0, node_test_1.describe)('OptOutEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        // UPDATE
        const opt_out_ref01_data_up0 = {};
        const opt_out_ref01_markdef_up0 = { name: 'channel', value: 'Mark01-opt_out_ref01_' + setup.now };
        opt_out_ref01_data_up0[opt_out_ref01_markdef_up0.name] = opt_out_ref01_markdef_up0.value;
        const opt_out_ref01_resdata_up0 = (await opt_out_ref01_ent.update(opt_out_ref01_data_up0)).data();
        (0, node_assert_1.default)(null != opt_out_ref01_resdata_up0);
        (0, node_assert_1.default)(opt_out_ref01_resdata_up0[opt_out_ref01_markdef_up0.name] === opt_out_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['opt_out01', 'opt_out02', 'opt_out03', 'customer01', 'customer02', 'customer03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
