...
(0, node_test_1.describe)('SubscriptionChannelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'subscription_channel.' + op, live))
                return;
        }
        ...
        let subscription_channel_ref01_data = Object.values(setup.data.existing.subscription_channel)[0];
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/subscription_channel/SubscriptionChannelTestData.json');
    ...
    let idmap = transform(['subscription_channel01', 'subscription_channel02', 'subscription_channel03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SubscriptionChannelEntity.test.js.map