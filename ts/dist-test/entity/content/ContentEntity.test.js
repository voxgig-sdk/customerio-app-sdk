...
(0, node_test_1.describe)('ContentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "content", "op": {}, "relations": { "ancestors": [["newsletter"], ["transactional"]] }, "key$": "content", "name__orig": "content", "Name": "Content", "name_": "content", "name-": "content", "NAME": "CONTENT", "index$": 8 }, { "active": true, "entity": "content", "key$": "BasicContentFlow", "kind": "basic", "name": "BasicContentFlow", "param": {}, "step": [] }, 'Content');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['content01', 'content02', 'content03', 'newsletter01', 'newsletter02', 'newsletter03', 'transactional01', 'transactional02', 'transactional03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'CUSTOMERIO_APP_TEST_CONTENT_ENTID': idmap,
        'CUSTOMERIO_APP_TEST_LIVE': 'FALSE',
        'CUSTOMERIO_APP_TEST_EXPLAIN': 'FALSE',
        'CUSTOMERIO_APP_APIKEY': '',
    });
    idmap = env['CUSTOMERIO_APP_TEST_CONTENT_ENTID'];
    const live = 'TRUE' === env.CUSTOMERIO_APP_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['CUSTOMERIO_APP_TEST_CONTENT_ENTID'];
