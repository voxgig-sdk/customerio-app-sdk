...
(0, node_test_1.describe)('AutomationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-automation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-automation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["action01", "campaign01"]))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    campaign_id: setup.idmap['campaign01'],
                },
            });
            ...
            const candidateId = listArr[0]?.action_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.action_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-automation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-automation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["campaign01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_AUTOMATION_ENTID'];
...
//# sourceMappingURL=AutomationDirect.test.js.map