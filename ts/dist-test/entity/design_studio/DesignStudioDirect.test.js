...
(0, node_test_1.describe)('DesignStudioDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-design_studio', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-design_studio', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-design_studio', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-design_studio', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_DESIGN_STUDIO_ENTID'];
...
//# sourceMappingURL=DesignStudioDirect.test.js.map