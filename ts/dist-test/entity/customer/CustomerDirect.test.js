...
(0, node_test_1.describe)('CustomerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-customer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-customer', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-customer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-customer', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["customer01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CUSTOMERIO_APP_TEST_CUSTOMER_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_CUSTOMER_ENTID'];
...
//# sourceMappingURL=CustomerDirect.test.js.map