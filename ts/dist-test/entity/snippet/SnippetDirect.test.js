...
(0, node_test_1.describe)('SnippetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-snippet', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-snippet', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_SNIPPET_ENTID'];
...
//# sourceMappingURL=SnippetDirect.test.js.map