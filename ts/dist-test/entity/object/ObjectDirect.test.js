...
(0, node_test_1.describe)('ObjectDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-object', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-object', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-object', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-object', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["object01", "object01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'CUSTOMERIO_APP_TEST_OBJECT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['CUSTOMERIO_APP_TEST_OBJECT_ENTID'];
...
//# sourceMappingURL=ObjectDirect.test.js.map