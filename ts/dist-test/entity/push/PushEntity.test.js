...
(0, node_test_1.describe)('PushEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'push.' + op, live))
                return;
        }
        const setup = basicSetup();
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "push", "op": {}, "relations": { "ancestors": [] }, "key$": "push", "name__orig": "push", "Name": "Push", "name_": "push", "name-": "push", "NAME": "PUSH", "index$": 33 }, { "active": true, "entity": "push", "key$": "BasicPushFlow", "kind": "basic", "name": "BasicPushFlow", "param": {}, "step": [] }, 'Push');
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['push01', 'push02', 'push03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
