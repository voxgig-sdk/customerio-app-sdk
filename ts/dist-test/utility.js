...
function envOverride(m) {
    if ('TRUE' === process.env.CUSTOMERIO_APP_TEST_LIVE ||
        'TRUE' === process.env.CUSTOMERIO_APP_TEST_OVERRIDE) {
    ...
    m.CUSTOMERIO_APP_TEST_EXPLAIN = process.env.CUSTOMERIO_APP_TEST_EXPLAIN || m.CUSTOMERIO_APP_TEST_EXPLAIN;
    return m;
}
