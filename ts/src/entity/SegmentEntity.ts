...
class SegmentEntity extends CustomerioAppEntityBase<Segment> {
  ...
  async load(this: any, reqmatch?: SegmentLoadMatch, ctrl?: Control): Promise<SegmentEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Segment> return stays clean under strict null checks.
  ...
  async list(this: any, reqmatch?: SegmentListMatch, ctrl?: Control): Promise<SegmentEntity[]> {
  ...
  async create(this: any, reqdata?: SegmentCreateData, ctrl?: Control): Promise<SegmentEntity> {
  ...
  async remove(
    this: any, reqmatch?: SegmentRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SegmentEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
