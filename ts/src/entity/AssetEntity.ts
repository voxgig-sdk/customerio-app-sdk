...
class AssetEntity extends CustomerioAppEntityBase<Asset> {
  ...
  async update(this: any, reqdata?: AssetUpdateData, ctrl?: Control): Promise<AssetEntity> {
