...
class SendMessageEntity extends CustomerioAppEntityBase<SendMessage> {
  ...
  async create(this: any, reqdata?: SendMessageCreateData, ctrl?: Control): Promise<SendMessageEntity> {
