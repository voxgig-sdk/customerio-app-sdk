...
const testSeed = `map[string]any{"entity": map[string]any{"action": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "activity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "asset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "attribute": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "broadcast": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "campaign": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "customer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_index": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "delivery": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "design_studio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "design_studio_email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "end": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "esp_suppression": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "import": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "in_app": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ip_address": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "language": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "link": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "live_notification": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "newsletter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "newsletter_metric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "newsletter_variant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "object_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "opt_out": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "push": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "relationship": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reporting_webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search_suppression": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "segment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sender_identity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sms": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "snippet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "start": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription_center": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription_channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription_topic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "suppression": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "test_group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transactional": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trigger": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whatsapp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "workspace": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
