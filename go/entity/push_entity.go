...
func NewPushEntity(client *core.CustomerioAppSDK, entopts map[string]any) *PushEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PushEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PushEntity) List(_ map[string]any, _ map[string]any) (any, error) {
