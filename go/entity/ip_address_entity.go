...
func NewIpAddressEntity(client *core.CustomerioAppSDK, entopts map[string]any) *IpAddressEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpAddressEntity) GetName() string { return e.name }
...
func (e *IpAddressEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpAddressEntity) Deleted() bool {
	return e.deleted
}


func (e *IpAddressEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpAddressEntity(e.client, opts)
}

func (e *IpAddressEntity) Data(args ...any) any {
...
func (e *IpAddressEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpAddress; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpAddressEntity) DataTyped(data ...IpAddress) IpAddress {
	if len(data) > 0 {
		return typedFrom[IpAddress](e.Data(asMap(data[0])))
	}
	return typedFrom[IpAddress](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpAddress (all fields
// optional at the wire level).
func (e *IpAddressEntity) MatchTyped(match ...IpAddress) IpAddress {
	if len(match) > 0 {
		return typedFrom[IpAddress](e.Match(asMap(match[0])))
	}
	return typedFrom[IpAddress](e.Match())
}
...
func (e *IpAddressEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpAddressEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IpAddressEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IpAddressEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IpAddressEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IpAddressEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpAddressEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
