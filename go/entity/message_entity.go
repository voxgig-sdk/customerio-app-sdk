...
func NewMessageEntity(client *core.CustomerioAppSDK, entopts map[string]any) *MessageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MessageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MessageListMatch and returns []Message. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MessageEntity) ListTyped(reqmatch MessageListMatch, ctrl map[string]any) ([]Message, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Message](res), nil
}



func (e *MessageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
