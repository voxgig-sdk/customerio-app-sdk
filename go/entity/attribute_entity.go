...
func NewAttributeEntity(client *core.CustomerioAppSDK, entopts map[string]any) *AttributeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AttributeEntity) GetName() string { return e.name }
...
func (e *AttributeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AttributeEntity) Deleted() bool {
	return e.deleted
}


func (e *AttributeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAttributeEntity(e.client, opts)
}

func (e *AttributeEntity) Data(args ...any) any {
...
func (e *AttributeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Attribute; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AttributeEntity) DataTyped(data ...Attribute) Attribute {
	if len(data) > 0 {
		return typedFrom[Attribute](e.Data(asMap(data[0])))
	}
	return typedFrom[Attribute](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Attribute (all fields
// optional at the wire level).
func (e *AttributeEntity) MatchTyped(match ...Attribute) Attribute {
	if len(match) > 0 {
		return typedFrom[Attribute](e.Match(asMap(match[0])))
	}
	return typedFrom[Attribute](e.Match())
}
...
func (e *AttributeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AttributeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AttributeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AttributeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AttributeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AttributeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AttributeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
