...
func NewUpdateEntity(client *core.CustomerioAppSDK, entopts map[string]any) *UpdateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UpdateEntity) List(_ map[string]any, _ map[string]any) (any, error) {
