...
func NewActivityEntity(client *core.CustomerioAppSDK, entopts map[string]any) *ActivityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActivityEntity) GetName() string { return e.name }
...
func (e *ActivityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActivityEntity) Deleted() bool {
	return e.deleted
}


func (e *ActivityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActivityEntity(e.client, opts)
}

func (e *ActivityEntity) Data(args ...any) any {
...
func (e *ActivityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Activity; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActivityEntity) DataTyped(data ...Activity) Activity {
	if len(data) > 0 {
		return typedFrom[Activity](e.Data(asMap(data[0])))
	}
	return typedFrom[Activity](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Activity (all fields
// optional at the wire level).
func (e *ActivityEntity) MatchTyped(match ...Activity) Activity {
	if len(match) > 0 {
		return typedFrom[Activity](e.Match(asMap(match[0])))
	}
	return typedFrom[Activity](e.Match())
}
...
func (e *ActivityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActivityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ActivityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActivityListMatch and returns []Activity. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ActivityEntity) ListTyped(reqmatch ActivityListMatch, ctrl map[string]any) ([]Activity, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Activity](res), nil
}



func (e *ActivityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActivityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActivityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActivityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
