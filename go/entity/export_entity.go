...
func NewExportEntity(client *core.CustomerioAppSDK, entopts map[string]any) *ExportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExportEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ExportCreateData and returns an Export. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ExportEntity) CreateTyped(reqdata ExportCreateData, ctrl map[string]any) (Export, error) {
