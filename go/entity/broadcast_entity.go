...
func NewBroadcastEntity(client *core.CustomerioAppSDK, entopts map[string]any) *BroadcastEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BroadcastEntity) GetName() string { return e.name }
...
func (e *BroadcastEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BroadcastEntity) Deleted() bool {
	return e.deleted
}


func (e *BroadcastEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBroadcastEntity(e.client, opts)
}

func (e *BroadcastEntity) Data(args ...any) any {
...
func (e *BroadcastEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Broadcast; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BroadcastEntity) DataTyped(data ...Broadcast) Broadcast {
	if len(data) > 0 {
		return typedFrom[Broadcast](e.Data(asMap(data[0])))
	}
	return typedFrom[Broadcast](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Broadcast (all fields
// optional at the wire level).
func (e *BroadcastEntity) MatchTyped(match ...Broadcast) Broadcast {
	if len(match) > 0 {
		return typedFrom[Broadcast](e.Match(asMap(match[0])))
	}
	return typedFrom[Broadcast](e.Match())
}
...
func (e *BroadcastEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BroadcastEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BroadcastLoadMatch and returns an Broadcast. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BroadcastEntity) LoadTyped(reqmatch BroadcastLoadMatch, ctrl map[string]any) (Broadcast, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Broadcast{}, err
	}
	return typedFrom[Broadcast](res), nil
}




func (e *BroadcastEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BroadcastListMatch and returns []Broadcast. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BroadcastEntity) ListTyped(reqmatch BroadcastListMatch, ctrl map[string]any) ([]Broadcast, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Broadcast](res), nil
}



func (e *BroadcastEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *BroadcastEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// BroadcastUpdateData and returns an Broadcast. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *BroadcastEntity) UpdateTyped(reqdata BroadcastUpdateData, ctrl map[string]any) (Broadcast, error) {
...
func (e *BroadcastEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BroadcastEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
