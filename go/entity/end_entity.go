...
func NewEndEntity(client *core.CustomerioAppSDK, entopts map[string]any) *EndEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EndEntity) GetName() string { return e.name }
...
func (e *EndEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EndEntity) Deleted() bool {
	return e.deleted
}


func (e *EndEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEndEntity(e.client, opts)
}

func (e *EndEntity) Data(args ...any) any {
...
func (e *EndEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an End; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EndEntity) DataTyped(data ...End) End {
	if len(data) > 0 {
		return typedFrom[End](e.Data(asMap(data[0])))
	}
	return typedFrom[End](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through End (all fields
// optional at the wire level).
func (e *EndEntity) MatchTyped(match ...End) End {
	if len(match) > 0 {
		return typedFrom[End](e.Match(asMap(match[0])))
	}
	return typedFrom[End](e.Match())
}
...
func (e *EndEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EndEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EndEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EndEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EndEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EndEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EndEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
