...
func NewWhatsappEntity(client *core.CustomerioAppSDK, entopts map[string]any) *WhatsappEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WhatsappEntity) GetName() string { return e.name }
...
func (e *WhatsappEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WhatsappEntity) Deleted() bool {
	return e.deleted
}


func (e *WhatsappEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWhatsappEntity(e.client, opts)
}

func (e *WhatsappEntity) Data(args ...any) any {
...
func (e *WhatsappEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Whatsapp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WhatsappEntity) DataTyped(data ...Whatsapp) Whatsapp {
	if len(data) > 0 {
		return typedFrom[Whatsapp](e.Data(asMap(data[0])))
	}
	return typedFrom[Whatsapp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Whatsapp (all fields
// optional at the wire level).
func (e *WhatsappEntity) MatchTyped(match ...Whatsapp) Whatsapp {
	if len(match) > 0 {
		return typedFrom[Whatsapp](e.Match(asMap(match[0])))
	}
	return typedFrom[Whatsapp](e.Match())
}
...
func (e *WhatsappEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WhatsappEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *WhatsappEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WhatsappEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WhatsappEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WhatsappEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WhatsappEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
