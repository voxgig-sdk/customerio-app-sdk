...
func NewDataIndexEntity(client *core.CustomerioAppSDK, entopts map[string]any) *DataIndexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataIndexEntity) GetName() string { return e.name }
...
func (e *DataIndexEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataIndexEntity) Deleted() bool {
	return e.deleted
}


func (e *DataIndexEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataIndexEntity(e.client, opts)
}

func (e *DataIndexEntity) Data(args ...any) any {
...
func (e *DataIndexEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataIndex; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataIndexEntity) DataTyped(data ...DataIndex) DataIndex {
	if len(data) > 0 {
		return typedFrom[DataIndex](e.Data(asMap(data[0])))
	}
	return typedFrom[DataIndex](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataIndex (all fields
// optional at the wire level).
func (e *DataIndexEntity) MatchTyped(match ...DataIndex) DataIndex {
	if len(match) > 0 {
		return typedFrom[DataIndex](e.Match(asMap(match[0])))
	}
	return typedFrom[DataIndex](e.Match())
}
...
func (e *DataIndexEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataIndexEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DataIndexEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DataIndexEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataIndexCreateData and returns an DataIndex. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DataIndexEntity) CreateTyped(reqdata DataIndexCreateData, ctrl map[string]any) (DataIndex, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DataIndex{}, err
	}
	return typedFrom[DataIndex](res), nil
}



func (e *DataIndexEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataIndexEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataIndexEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
