...
type SubscriptionTopicEntity struct {
	name    string
...
func NewSubscriptionTopicEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SubscriptionTopicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubscriptionTopicEntity) GetName() string { return e.name }
...
func (e *SubscriptionTopicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubscriptionTopicEntity) Deleted() bool {
	return e.deleted
}


func (e *SubscriptionTopicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubscriptionTopicEntity(e.client, opts)
}

func (e *SubscriptionTopicEntity) Data(args ...any) any {
...
func (e *SubscriptionTopicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SubscriptionTopic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubscriptionTopicEntity) DataTyped(data ...SubscriptionTopic) SubscriptionTopic {
	if len(data) > 0 {
		return typedFrom[SubscriptionTopic](e.Data(asMap(data[0])))
	}
	return typedFrom[SubscriptionTopic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SubscriptionTopic (all fields
// optional at the wire level).
func (e *SubscriptionTopicEntity) MatchTyped(match ...SubscriptionTopic) SubscriptionTopic {
	if len(match) > 0 {
		return typedFrom[SubscriptionTopic](e.Match(asMap(match[0])))
	}
	return typedFrom[SubscriptionTopic](e.Match())
}
...
func (e *SubscriptionTopicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubscriptionTopicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SubscriptionTopicEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SubscriptionTopicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubscriptionTopicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubscriptionTopicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubscriptionTopicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
