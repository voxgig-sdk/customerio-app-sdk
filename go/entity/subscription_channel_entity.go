...
type SubscriptionChannelEntity struct {
	name    string
...
func NewSubscriptionChannelEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SubscriptionChannelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubscriptionChannelEntity) GetName() string { return e.name }
...
func (e *SubscriptionChannelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubscriptionChannelEntity) Deleted() bool {
	return e.deleted
}


func (e *SubscriptionChannelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubscriptionChannelEntity(e.client, opts)
}

func (e *SubscriptionChannelEntity) Data(args ...any) any {
...
func (e *SubscriptionChannelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SubscriptionChannel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubscriptionChannelEntity) DataTyped(data ...SubscriptionChannel) SubscriptionChannel {
	if len(data) > 0 {
		return typedFrom[SubscriptionChannel](e.Data(asMap(data[0])))
	}
	return typedFrom[SubscriptionChannel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SubscriptionChannel (all fields
// optional at the wire level).
func (e *SubscriptionChannelEntity) MatchTyped(match ...SubscriptionChannel) SubscriptionChannel {
	if len(match) > 0 {
		return typedFrom[SubscriptionChannel](e.Match(asMap(match[0])))
	}
	return typedFrom[SubscriptionChannel](e.Match())
}
...
func (e *SubscriptionChannelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubscriptionChannelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SubscriptionChannelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SubscriptionChannelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubscriptionChannelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubscriptionChannelEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubscriptionChannelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
