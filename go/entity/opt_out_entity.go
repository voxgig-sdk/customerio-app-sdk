...
func NewOptOutEntity(client *core.CustomerioAppSDK, entopts map[string]any) *OptOutEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OptOutEntity) GetName() string { return e.name }
...
func (e *OptOutEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OptOutEntity) Deleted() bool {
	return e.deleted
}


func (e *OptOutEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOptOutEntity(e.client, opts)
}

func (e *OptOutEntity) Data(args ...any) any {
...
func (e *OptOutEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OptOut; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OptOutEntity) DataTyped(data ...OptOut) OptOut {
	if len(data) > 0 {
		return typedFrom[OptOut](e.Data(asMap(data[0])))
	}
	return typedFrom[OptOut](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OptOut (all fields
// optional at the wire level).
func (e *OptOutEntity) MatchTyped(match ...OptOut) OptOut {
	if len(match) > 0 {
		return typedFrom[OptOut](e.Match(asMap(match[0])))
	}
	return typedFrom[OptOut](e.Match())
}
...
func (e *OptOutEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OptOutEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *OptOutEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OptOutListMatch and returns []OptOut. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OptOutEntity) ListTyped(reqmatch OptOutListMatch, ctrl map[string]any) ([]OptOut, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[OptOut](res), nil
}



func (e *OptOutEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *OptOutEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// OptOutUpdateData and returns an OptOut. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *OptOutEntity) UpdateTyped(reqdata OptOutUpdateData, ctrl map[string]any) (OptOut, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return OptOut{}, err
	}
	return typedFrom[OptOut](res), nil
}



func (e *OptOutEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OptOutEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
