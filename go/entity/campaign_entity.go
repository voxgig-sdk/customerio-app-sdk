...
func NewCampaignEntity(client *core.CustomerioAppSDK, entopts map[string]any) *CampaignEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CampaignEntity) GetName() string { return e.name }
...
func (e *CampaignEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CampaignEntity) Deleted() bool {
	return e.deleted
}


func (e *CampaignEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCampaignEntity(e.client, opts)
}

func (e *CampaignEntity) Data(args ...any) any {
...
func (e *CampaignEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Campaign; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CampaignEntity) DataTyped(data ...Campaign) Campaign {
	if len(data) > 0 {
		return typedFrom[Campaign](e.Data(asMap(data[0])))
	}
	return typedFrom[Campaign](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Campaign (all fields
// optional at the wire level).
func (e *CampaignEntity) MatchTyped(match ...Campaign) Campaign {
	if len(match) > 0 {
		return typedFrom[Campaign](e.Match(asMap(match[0])))
	}
	return typedFrom[Campaign](e.Match())
}
...
func (e *CampaignEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CampaignEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CampaignEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CampaignEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CampaignEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CampaignEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CampaignEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
