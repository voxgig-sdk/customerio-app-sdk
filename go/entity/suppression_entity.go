...
func NewSuppressionEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SuppressionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SuppressionEntity) GetName() string { return e.name }
...
func (e *SuppressionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SuppressionEntity) Deleted() bool {
	return e.deleted
}


func (e *SuppressionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSuppressionEntity(e.client, opts)
}

func (e *SuppressionEntity) Data(args ...any) any {
...
func (e *SuppressionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Suppression; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SuppressionEntity) DataTyped(data ...Suppression) Suppression {
	if len(data) > 0 {
		return typedFrom[Suppression](e.Data(asMap(data[0])))
	}
	return typedFrom[Suppression](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Suppression (all fields
// optional at the wire level).
func (e *SuppressionEntity) MatchTyped(match ...Suppression) Suppression {
	if len(match) > 0 {
		return typedFrom[Suppression](e.Match(asMap(match[0])))
	}
	return typedFrom[Suppression](e.Match())
}
...
func (e *SuppressionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SuppressionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SuppressionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SuppressionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SuppressionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SuppressionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SuppressionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
