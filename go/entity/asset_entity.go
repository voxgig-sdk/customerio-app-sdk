...
func NewAssetEntity(client *core.CustomerioAppSDK, entopts map[string]any) *AssetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AssetEntity) GetName() string { return e.name }
...
func (e *AssetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AssetEntity) Deleted() bool {
	return e.deleted
}


func (e *AssetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAssetEntity(e.client, opts)
}

func (e *AssetEntity) Data(args ...any) any {
...
func (e *AssetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AssetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AssetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *AssetEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *AssetEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AssetUpdateData and returns an Asset. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AssetEntity) UpdateTyped(reqdata AssetUpdateData, ctrl map[string]any) (Asset, error) {
...
func (e *AssetEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *AssetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
