...
func NewTestGroupEntity(client *core.CustomerioAppSDK, entopts map[string]any) *TestGroupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TestGroupEntity) GetName() string { return e.name }
...
func (e *TestGroupEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TestGroupEntity) Deleted() bool {
	return e.deleted
}


func (e *TestGroupEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTestGroupEntity(e.client, opts)
}

func (e *TestGroupEntity) Data(args ...any) any {
...
func (e *TestGroupEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TestGroup; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TestGroupEntity) DataTyped(data ...TestGroup) TestGroup {
	if len(data) > 0 {
		return typedFrom[TestGroup](e.Data(asMap(data[0])))
	}
	return typedFrom[TestGroup](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TestGroup (all fields
// optional at the wire level).
func (e *TestGroupEntity) MatchTyped(match ...TestGroup) TestGroup {
	if len(match) > 0 {
		return typedFrom[TestGroup](e.Match(asMap(match[0])))
	}
	return typedFrom[TestGroup](e.Match())
}
...
func (e *TestGroupEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TestGroupEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TestGroupEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TestGroupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TestGroupEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TestGroupEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TestGroupEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
