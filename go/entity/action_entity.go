...
func NewActionEntity(client *core.CustomerioAppSDK, entopts map[string]any) *ActionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
