...
func NewImportEntity(client *core.CustomerioAppSDK, entopts map[string]any) *ImportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ImportEntity) GetName() string { return e.name }
...
func (e *ImportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ImportEntity) Deleted() bool {
	return e.deleted
}


func (e *ImportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewImportEntity(e.client, opts)
}

func (e *ImportEntity) Data(args ...any) any {
...
func (e *ImportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Import; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ImportEntity) DataTyped(data ...Import) Import {
	if len(data) > 0 {
		return typedFrom[Import](e.Data(asMap(data[0])))
	}
	return typedFrom[Import](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Import (all fields
// optional at the wire level).
func (e *ImportEntity) MatchTyped(match ...Import) Import {
	if len(match) > 0 {
		return typedFrom[Import](e.Match(asMap(match[0])))
	}
	return typedFrom[Import](e.Match())
}
...
func (e *ImportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ImportEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ImportLoadMatch and returns an Import. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ImportEntity) LoadTyped(reqmatch ImportLoadMatch, ctrl map[string]any) (Import, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Import{}, err
	}
	return typedFrom[Import](res), nil
}



func (e *ImportEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ImportEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ImportCreateData and returns an Import. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ImportEntity) CreateTyped(reqdata ImportCreateData, ctrl map[string]any) (Import, error) {
...
func (e *ImportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ImportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ImportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
