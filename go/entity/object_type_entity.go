...
func NewObjectTypeEntity(client *core.CustomerioAppSDK, entopts map[string]any) *ObjectTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ObjectTypeEntity) GetName() string { return e.name }
...
func (e *ObjectTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ObjectTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *ObjectTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewObjectTypeEntity(e.client, opts)
}

func (e *ObjectTypeEntity) Data(args ...any) any {
...
func (e *ObjectTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ObjectType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ObjectTypeEntity) DataTyped(data ...ObjectType) ObjectType {
	if len(data) > 0 {
		return typedFrom[ObjectType](e.Data(asMap(data[0])))
	}
	return typedFrom[ObjectType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ObjectType (all fields
// optional at the wire level).
func (e *ObjectTypeEntity) MatchTyped(match ...ObjectType) ObjectType {
	if len(match) > 0 {
		return typedFrom[ObjectType](e.Match(asMap(match[0])))
	}
	return typedFrom[ObjectType](e.Match())
}
...
func (e *ObjectTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ObjectTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ObjectTypeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ObjectTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ObjectTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ObjectTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ObjectTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
