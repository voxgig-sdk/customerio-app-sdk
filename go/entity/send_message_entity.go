...
func NewSendMessageEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SendMessageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SendMessageEntity) GetName() string { return e.name }
...
func (e *SendMessageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SendMessageEntity) Deleted() bool {
	return e.deleted
}


func (e *SendMessageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSendMessageEntity(e.client, opts)
}

func (e *SendMessageEntity) Data(args ...any) any {
...
func (e *SendMessageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SendMessage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SendMessageEntity) DataTyped(data ...SendMessage) SendMessage {
	if len(data) > 0 {
		return typedFrom[SendMessage](e.Data(asMap(data[0])))
	}
	return typedFrom[SendMessage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SendMessage (all fields
// optional at the wire level).
func (e *SendMessageEntity) MatchTyped(match ...SendMessage) SendMessage {
	if len(match) > 0 {
		return typedFrom[SendMessage](e.Match(asMap(match[0])))
	}
	return typedFrom[SendMessage](e.Match())
}
...
func (e *SendMessageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SendMessageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SendMessageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SendMessageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SendMessageCreateData and returns an SendMessage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SendMessageEntity) CreateTyped(reqdata SendMessageCreateData, ctrl map[string]any) (SendMessage, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SendMessage{}, err
	}
	return typedFrom[SendMessage](res), nil
}



func (e *SendMessageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SendMessageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SendMessageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
