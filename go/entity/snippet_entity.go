...
func NewSnippetEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SnippetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SnippetEntity) GetName() string { return e.name }
...
func (e *SnippetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SnippetEntity) Deleted() bool {
	return e.deleted
}


func (e *SnippetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSnippetEntity(e.client, opts)
}

func (e *SnippetEntity) Data(args ...any) any {
...
func (e *SnippetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Snippet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SnippetEntity) DataTyped(data ...Snippet) Snippet {
	if len(data) > 0 {
		return typedFrom[Snippet](e.Data(asMap(data[0])))
	}
	return typedFrom[Snippet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Snippet (all fields
// optional at the wire level).
func (e *SnippetEntity) MatchTyped(match ...Snippet) Snippet {
	if len(match) > 0 {
		return typedFrom[Snippet](e.Match(asMap(match[0])))
	}
	return typedFrom[Snippet](e.Match())
}
...
func (e *SnippetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SnippetEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SnippetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SnippetListMatch and returns []Snippet. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SnippetEntity) ListTyped(reqmatch SnippetListMatch, ctrl map[string]any) ([]Snippet, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Snippet](res), nil
}




func (e *SnippetEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// SnippetCreateData and returns an Snippet. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SnippetEntity) CreateTyped(reqdata SnippetCreateData, ctrl map[string]any) (Snippet, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Snippet{}, err
	}
	return typedFrom[Snippet](res), nil
}




func (e *SnippetEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// SnippetUpdateData and returns an Snippet. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *SnippetEntity) UpdateTyped(reqdata SnippetUpdateData, ctrl map[string]any) (Snippet, error) {
...
func (e *SnippetEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// SnippetRemoveMatch and returns an Snippet. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SnippetEntity) RemoveTyped(reqmatch SnippetRemoveMatch, ctrl map[string]any) (Snippet, error) {
...
func (e *SnippetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
