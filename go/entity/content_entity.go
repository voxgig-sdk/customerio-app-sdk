...
func NewContentEntity(client *core.CustomerioAppSDK, entopts map[string]any) *ContentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
