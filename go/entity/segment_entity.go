...
func NewSegmentEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SegmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SegmentEntity) GetName() string { return e.name }
...
func (e *SegmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SegmentEntity) Deleted() bool {
	return e.deleted
}


func (e *SegmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSegmentEntity(e.client, opts)
}

func (e *SegmentEntity) Data(args ...any) any {
...
func (e *SegmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Segment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SegmentEntity) DataTyped(data ...Segment) Segment {
	if len(data) > 0 {
		return typedFrom[Segment](e.Data(asMap(data[0])))
	}
	return typedFrom[Segment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Segment (all fields
// optional at the wire level).
func (e *SegmentEntity) MatchTyped(match ...Segment) Segment {
	if len(match) > 0 {
		return typedFrom[Segment](e.Match(asMap(match[0])))
	}
	return typedFrom[Segment](e.Match())
}
...
func (e *SegmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SegmentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SegmentLoadMatch and returns an Segment. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SegmentEntity) LoadTyped(reqmatch SegmentLoadMatch, ctrl map[string]any) (Segment, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Segment{}, err
	}
	return typedFrom[Segment](res), nil
}




func (e *SegmentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SegmentListMatch and returns []Segment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SegmentEntity) ListTyped(reqmatch SegmentListMatch, ctrl map[string]any) ([]Segment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Segment](res), nil
}




func (e *SegmentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// SegmentCreateData and returns an Segment. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SegmentEntity) CreateTyped(reqdata SegmentCreateData, ctrl map[string]any) (Segment, error) {
...
func (e *SegmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *SegmentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// SegmentRemoveMatch and returns an Segment. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SegmentEntity) RemoveTyped(reqmatch SegmentRemoveMatch, ctrl map[string]any) (Segment, error) {
...
func (e *SegmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
