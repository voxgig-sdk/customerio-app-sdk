...
func NewWorkspaceEntity(client *core.CustomerioAppSDK, entopts map[string]any) *WorkspaceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkspaceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *WorkspaceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WorkspaceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorkspaceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
