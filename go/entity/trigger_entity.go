...
func NewTriggerEntity(client *core.CustomerioAppSDK, entopts map[string]any) *TriggerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TriggerEntity) GetName() string { return e.name }
...
func (e *TriggerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TriggerEntity) Deleted() bool {
	return e.deleted
}


func (e *TriggerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTriggerEntity(e.client, opts)
}

func (e *TriggerEntity) Data(args ...any) any {
...
func (e *TriggerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Trigger; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TriggerEntity) DataTyped(data ...Trigger) Trigger {
	if len(data) > 0 {
		return typedFrom[Trigger](e.Data(asMap(data[0])))
	}
	return typedFrom[Trigger](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Trigger (all fields
// optional at the wire level).
func (e *TriggerEntity) MatchTyped(match ...Trigger) Trigger {
	if len(match) > 0 {
		return typedFrom[Trigger](e.Match(asMap(match[0])))
	}
	return typedFrom[Trigger](e.Match())
}
...
func (e *TriggerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TriggerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TriggerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TriggerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TriggerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TriggerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TriggerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
