...
func NewLanguageEntity(client *core.CustomerioAppSDK, entopts map[string]any) *LanguageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LanguageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LanguageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
