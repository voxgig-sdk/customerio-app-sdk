...
func NewDeliveryEntity(client *core.CustomerioAppSDK, entopts map[string]any) *DeliveryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeliveryEntity) GetName() string { return e.name }
...
func (e *DeliveryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeliveryEntity) Deleted() bool {
	return e.deleted
}


func (e *DeliveryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeliveryEntity(e.client, opts)
}

func (e *DeliveryEntity) Data(args ...any) any {
...
func (e *DeliveryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Delivery; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeliveryEntity) DataTyped(data ...Delivery) Delivery {
	if len(data) > 0 {
		return typedFrom[Delivery](e.Data(asMap(data[0])))
	}
	return typedFrom[Delivery](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Delivery (all fields
// optional at the wire level).
func (e *DeliveryEntity) MatchTyped(match ...Delivery) Delivery {
	if len(match) > 0 {
		return typedFrom[Delivery](e.Match(asMap(match[0])))
	}
	return typedFrom[Delivery](e.Match())
}
...
func (e *DeliveryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeliveryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeliveryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeliveryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeliveryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeliveryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeliveryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
