...
type InboxMessageEntity struct {
	name    string
...
func NewInboxMessageEntity(client *core.CustomerioAppSDK, entopts map[string]any) *InboxMessageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InboxMessageEntity) GetName() string { return e.name }
...
func (e *InboxMessageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InboxMessageEntity) Deleted() bool {
	return e.deleted
}


func (e *InboxMessageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInboxMessageEntity(e.client, opts)
}

func (e *InboxMessageEntity) Data(args ...any) any {
...
func (e *InboxMessageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an InboxMessage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InboxMessageEntity) DataTyped(data ...InboxMessage) InboxMessage {
	if len(data) > 0 {
		return typedFrom[InboxMessage](e.Data(asMap(data[0])))
	}
	return typedFrom[InboxMessage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through InboxMessage (all fields
// optional at the wire level).
func (e *InboxMessageEntity) MatchTyped(match ...InboxMessage) InboxMessage {
	if len(match) > 0 {
		return typedFrom[InboxMessage](e.Match(asMap(match[0])))
	}
	return typedFrom[InboxMessage](e.Match())
}
...
func (e *InboxMessageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InboxMessageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *InboxMessageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InboxMessageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InboxMessageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InboxMessageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InboxMessageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
