...
func NewRelationshipEntity(client *core.CustomerioAppSDK, entopts map[string]any) *RelationshipEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RelationshipEntity) GetName() string { return e.name }
...
func (e *RelationshipEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RelationshipEntity) Deleted() bool {
	return e.deleted
}


func (e *RelationshipEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRelationshipEntity(e.client, opts)
}

func (e *RelationshipEntity) Data(args ...any) any {
...
func (e *RelationshipEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Relationship; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RelationshipEntity) DataTyped(data ...Relationship) Relationship {
	if len(data) > 0 {
		return typedFrom[Relationship](e.Data(asMap(data[0])))
	}
	return typedFrom[Relationship](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Relationship (all fields
// optional at the wire level).
func (e *RelationshipEntity) MatchTyped(match ...Relationship) Relationship {
	if len(match) > 0 {
		return typedFrom[Relationship](e.Match(asMap(match[0])))
	}
	return typedFrom[Relationship](e.Match())
}
...
func (e *RelationshipEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RelationshipEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RelationshipEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RelationshipEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RelationshipEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RelationshipEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RelationshipEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
