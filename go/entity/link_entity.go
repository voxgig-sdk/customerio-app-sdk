...
func NewLinkEntity(client *core.CustomerioAppSDK, entopts map[string]any) *LinkEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LinkEntity) GetName() string { return e.name }
...
func (e *LinkEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LinkEntity) Deleted() bool {
	return e.deleted
}


func (e *LinkEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLinkEntity(e.client, opts)
}

func (e *LinkEntity) Data(args ...any) any {
...
func (e *LinkEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *LinkEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LinkEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LinkEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LinkEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LinkEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LinkEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LinkEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
