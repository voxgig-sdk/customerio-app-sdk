...
func NewInfoEntity(client *core.CustomerioAppSDK, entopts map[string]any) *InfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InfoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *InfoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InfoListMatch and returns []Info. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *InfoEntity) ListTyped(reqmatch InfoListMatch, ctrl map[string]any) ([]Info, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Info](res), nil
}
