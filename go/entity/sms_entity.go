...
func NewSmsEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SmsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SmsEntity) GetName() string { return e.name }
...
func (e *SmsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SmsEntity) Deleted() bool {
	return e.deleted
}


func (e *SmsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSmsEntity(e.client, opts)
}

func (e *SmsEntity) Data(args ...any) any {
...
func (e *SmsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Sms; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SmsEntity) DataTyped(data ...Sms) Sms {
	if len(data) > 0 {
		return typedFrom[Sms](e.Data(asMap(data[0])))
	}
	return typedFrom[Sms](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Sms (all fields
// optional at the wire level).
func (e *SmsEntity) MatchTyped(match ...Sms) Sms {
	if len(match) > 0 {
		return typedFrom[Sms](e.Match(asMap(match[0])))
	}
	return typedFrom[Sms](e.Match())
}
...
func (e *SmsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SmsEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SmsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SmsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SmsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SmsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SmsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
