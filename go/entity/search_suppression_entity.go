...
type SearchSuppressionEntity struct {
	name    string
...
func NewSearchSuppressionEntity(client *core.CustomerioAppSDK, entopts map[string]any) *SearchSuppressionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SearchSuppressionEntity) GetName() string { return e.name }
...
func (e *SearchSuppressionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SearchSuppressionEntity) Deleted() bool {
	return e.deleted
}


func (e *SearchSuppressionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSearchSuppressionEntity(e.client, opts)
}

func (e *SearchSuppressionEntity) Data(args ...any) any {
...
func (e *SearchSuppressionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SearchSuppression; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SearchSuppressionEntity) DataTyped(data ...SearchSuppression) SearchSuppression {
	if len(data) > 0 {
		return typedFrom[SearchSuppression](e.Data(asMap(data[0])))
	}
	return typedFrom[SearchSuppression](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SearchSuppression (all fields
// optional at the wire level).
func (e *SearchSuppressionEntity) MatchTyped(match ...SearchSuppression) SearchSuppression {
	if len(match) > 0 {
		return typedFrom[SearchSuppression](e.Match(asMap(match[0])))
	}
	return typedFrom[SearchSuppression](e.Match())
}
...
func (e *SearchSuppressionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SearchSuppressionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SearchSuppressionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SearchSuppressionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SearchSuppressionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SearchSuppressionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SearchSuppressionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
