...
func NewEmailEntity(client *core.CustomerioAppSDK, entopts map[string]any) *EmailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
