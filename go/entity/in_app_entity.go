...
func NewInAppEntity(client *core.CustomerioAppSDK, entopts map[string]any) *InAppEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InAppEntity) GetName() string { return e.name }
...
func (e *InAppEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InAppEntity) Deleted() bool {
	return e.deleted
}


func (e *InAppEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInAppEntity(e.client, opts)
}

func (e *InAppEntity) Data(args ...any) any {
...
func (e *InAppEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an InApp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InAppEntity) DataTyped(data ...InApp) InApp {
	if len(data) > 0 {
		return typedFrom[InApp](e.Data(asMap(data[0])))
	}
	return typedFrom[InApp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through InApp (all fields
// optional at the wire level).
func (e *InAppEntity) MatchTyped(match ...InApp) InApp {
	if len(match) > 0 {
		return typedFrom[InApp](e.Match(asMap(match[0])))
	}
	return typedFrom[InApp](e.Match())
}
...
func (e *InAppEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InAppEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *InAppEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InAppEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InAppEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InAppEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InAppEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
