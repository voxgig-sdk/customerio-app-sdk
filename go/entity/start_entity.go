...
func NewStartEntity(client *core.CustomerioAppSDK, entopts map[string]any) *StartEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StartEntity) GetName() string { return e.name }
...
func (e *StartEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StartEntity) Deleted() bool {
	return e.deleted
}


func (e *StartEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStartEntity(e.client, opts)
}

func (e *StartEntity) Data(args ...any) any {
...
func (e *StartEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Start; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StartEntity) DataTyped(data ...Start) Start {
	if len(data) > 0 {
		return typedFrom[Start](e.Data(asMap(data[0])))
	}
	return typedFrom[Start](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Start (all fields
// optional at the wire level).
func (e *StartEntity) MatchTyped(match ...Start) Start {
	if len(match) > 0 {
		return typedFrom[Start](e.Match(asMap(match[0])))
	}
	return typedFrom[Start](e.Match())
}
...
func (e *StartEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StartEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *StartEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *StartEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StartEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StartEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StartEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
