...
describe('SnippetEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(snippet_ref01_resdata_up0[snippet_ref01_markdef_up0.name] === snippet_ref01_markdef_up0.value)


    // REMOVE
    const snippet_ref01_match_rm0 = {}
    snippet_ref01_match_rm0.id = snippet_ref01_data.id
