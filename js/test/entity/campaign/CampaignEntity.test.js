...
describe('CampaignEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.live) {
      return runLiveEntity(setup, {"active":true,"alias":{"field":{}},"fields":[],"name":"campaign","op":{},"relations":{"ancestors":[]},"key$":"campaign","name__orig":"campaign","Name":"Campaign","name_":"campaign","name-":"campaign","NAME":"CAMPAIGN","index$":6}, {"active":true,"entity":"campaign","key$":"BasicCampaignFlow","kind":"basic","name":"BasicCampaignFlow","param":{},"step":[]}, 'Campaign')
    }
    ...
    let campaign_ref01_data = Object.values(setup.data.existing.campaign)[0]
...
function basicSetup(extra) {
  ...
  idmap = env['CUSTOMERIO_APP_TEST_CAMPAIGN_ENTID']

  const live = 'TRUE' === env.CUSTOMERIO_APP_TEST_LIVE
  const transport = createLiveTransport()
  if (live) {
    const rawIds = process.env['CUSTOMERIO_APP_TEST_CAMPAIGN_ENTID']
