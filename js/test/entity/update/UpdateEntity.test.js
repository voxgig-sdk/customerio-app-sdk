...
describe('UpdateEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.live) {
      return runLiveEntity(setup, {"active":true,"alias":{"field":{}},"fields":[],"name":"update","op":{},"relations":{"ancestors":[]},"key$":"update","name__orig":"update","Name":"Update","name_":"update","name-":"update","NAME":"UPDATE","index$":50}, {"active":true,"entity":"update","key$":"BasicUpdateFlow","kind":"basic","name":"BasicUpdateFlow","param":{},"step":[]}, 'Update')
    }
