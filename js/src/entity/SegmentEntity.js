...
class SegmentEntity extends CustomerioAppEntityBase {
  ...
  /**
   * @param {SegmentLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {SegmentListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Segment[]>}
   */
  ...
  /**
   * @param {SegmentCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Segment>}
   */
  ...
  /**
   * @param {SegmentRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Segment>}
   */
