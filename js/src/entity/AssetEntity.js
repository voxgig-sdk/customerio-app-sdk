...
class AssetEntity extends CustomerioAppEntityBase {
  ...
  make() {
    return new AssetEntity(this._client, this.entopts())
  }



  /**
   * @param {AssetLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {AssetRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Asset>}
   */
