    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set CUSTOMERIO_APP_TEST_OPT_OUT_ENTID JSON to run live")
        client = setup["client"]
        ...
        opt_out_ref01_markdef_up0_value = "Mark01-opt_out_ref01_" + str(setup["now"])
        opt_out_ref01_data_up0_up[opt_out_ref01_markdef_up0_name] = opt_out_ref01_markdef_up0_value

        opt_out_ref01_resdata_up0 = helpers.to_map(runner.entity_data(opt_out_ref01_ent.update(opt_out_ref01_data_up0_up, None)))
        assert opt_out_ref01_resdata_up0 is not None
        assert opt_out_ref01_resdata_up0[opt_out_ref01_markdef_up0_name] == opt_out_ref01_markdef_up0_value
...
def _opt_out_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "CUSTOMERIO_APP_TEST_OPT_OUT_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("CUSTOMERIO_APP_TEST_OPT_OUT_ENTID"))
