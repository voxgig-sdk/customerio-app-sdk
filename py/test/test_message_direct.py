...
class TestMessageDirect:
    ...
    def test_should_direct_list_message(self):
        setup = _message_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-message", "live" if setup["live"] else "unit")
        if _skip:
