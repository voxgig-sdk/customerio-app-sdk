...
class TestInfoDirect:
    ...
    def test_should_direct_list_info(self):
        setup = _info_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-info", "live" if setup["live"] else "unit")
        if _skip:
