# CustomerioApp SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CustomerioAppSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CustomerioAppSDK(...) and CustomerioAppSDK.test(...) become
#      CustomerioAppSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "customerioapp_sdk"
_SDK_CLASS = "CustomerioAppSDK"
...
_ENTITIES = {
    ...
    "DesignStudioEmail": "design_studio_email",
    "Email": "email",
    "End": "end",
    "EspSuppression": "esp_suppression",
    "Export": "export",
    "Import": "import",
    "InApp": "in_app",
    ...
    "Language": "language",
    "Link": "link",
    "LiveNotification": "live_notification",
    "Message": "message",
    "Newsletter": "newsletter",
    "NewsletterMetric": "newsletter_metric",
    "NewsletterVariant": "newsletter_variant",
    "Object": "object",
    "ObjectType": "object_type",
    "OptOut": "opt_out",
    "Push": "push",
    "Relationship": "relationship",
    "ReportingWebhook": "reporting_webhook",
    "SearchSuppression": "search_suppression",
    "Segment": "segment",
    ...
    "Snippet": "snippet",
    "Start": "start",
    "SubscriptionCenter": "subscription_center",
