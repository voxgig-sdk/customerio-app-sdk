...
class SendMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SendMessageEntity(self._client, opts)
    ...
    def match_get(self) -> SendMessage:
    ...
    def create(self, reqdata: SendMessageCreateData, ctrl=None) -> SendMessage:
        utility = self._utility
