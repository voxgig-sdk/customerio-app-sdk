...
class DataIndexEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataIndexEntity(self._client, opts)
    ...
    def create(self, reqdata: DataIndexCreateData, ctrl=None) -> DataIndex:
        utility = self._utility
