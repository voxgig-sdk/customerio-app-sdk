...
from customerioapp_sdk.customerioapp_types import (
    DesignStudioEmail,
...
class DesignStudioEmailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DesignStudioEmailEntity(self._client, opts)
    ...
    def data_get(self) -> DesignStudioEmail:
    ...
    def match_get(self) -> DesignStudioEmail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DesignStudioEmail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DesignStudioEmail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DesignStudioEmail]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DesignStudioEmail().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: DesignStudioEmailCreateData, ctrl=None) -> DesignStudioEmail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: DesignStudioEmailUpdateData, ctrl=None) -> DesignStudioEmail:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> DesignStudioEmail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.DesignStudioEmail().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
