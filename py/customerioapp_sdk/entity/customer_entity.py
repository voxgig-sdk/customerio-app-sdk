...
class CustomerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomerEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Customer]:
        ...
        # as an empty match so client.Customer().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
