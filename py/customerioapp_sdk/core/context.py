...
from customerioapp_sdk.core.control import CustomerioAppControl
...
from customerioapp_sdk.core.helpers import get_ctx_prop, to_map
...
class CustomerioAppContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CustomerioAppControl()
        ...
        if isinstance(sp, CustomerioAppSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CustomerioAppResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CustomerioAppResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CustomerioAppError(code, msg, self)
