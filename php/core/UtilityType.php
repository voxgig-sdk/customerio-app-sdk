...
// CustomerioApp SDK utility type

class CustomerioAppUtility
{
    ...
    public static function copy(CustomerioAppUtility $src): CustomerioAppUtility
    {
        $u = new CustomerioAppUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
