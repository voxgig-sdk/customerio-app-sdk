...
// CustomerioApp SDK paging feature
...
class CustomerioAppPagingFeature extends CustomerioAppBaseFeature
{
    ...
    private function _graphql_pre_request(CustomerioAppContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(CustomerioAppContext $ctx): bool
    {
