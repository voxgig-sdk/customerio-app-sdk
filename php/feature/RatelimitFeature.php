...
// CustomerioApp SDK ratelimit feature
...
class CustomerioAppRatelimitFeature extends CustomerioAppBaseFeature
{
    ...
    private function _acquire(CustomerioAppContext $ctx): void
    {
    ...
    private function _track(CustomerioAppContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
