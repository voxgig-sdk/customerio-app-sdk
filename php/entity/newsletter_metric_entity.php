...
// CustomerioApp SDK NewsletterMetric entity
...
class NewsletterMetricEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NewsletterMetricEntity($this->_client, $opts);
    }

    /**
     * @param NewsletterMetric|array $args NewsletterMetric data (assoc-array) to store.
     */
    ...
    /**
     * @return NewsletterMetric|array The current NewsletterMetric data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NewsletterMetric fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NewsletterMetric fields).
     */
    ...
    /**
     * Load a single NewsletterMetric.
     *
     * @param NewsletterMetricLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NewsletterMetricLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterMetric|array The loaded NewsletterMetric as an assoc-array at the
    ...
    /**
     * List NewsletterMetric items matching the given filter.
     *
     * @param NewsletterMetricListMatch|array|null $reqmatch Match filter (any subset
     *   of NewsletterMetric fields) as an assoc-array; NewsletterMetricListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterMetric[]|array A list of NewsletterMetric items as assoc-arrays at
