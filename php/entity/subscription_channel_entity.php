...
class SubscriptionChannelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscription_channel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionChannelEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionChannel|array $args SubscriptionChannel data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionChannel|array The current SubscriptionChannel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionChannel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionChannel fields).
     */
