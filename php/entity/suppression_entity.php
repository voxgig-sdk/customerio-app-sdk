...
class SuppressionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SuppressionEntity($this->_client, $opts);
    }

    /**
     * @param Suppression|array $args Suppression data (assoc-array) to store.
     */
    ...
    /**
     * @return Suppression|array The current Suppression data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Suppression fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Suppression fields).
     */
