...
// CustomerioApp SDK Newsletter entity
...
class NewsletterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NewsletterEntity($this->_client, $opts);
    }

    /**
     * @param Newsletter|array $args Newsletter data (assoc-array) to store.
     */
    ...
    /**
     * @return Newsletter|array The current Newsletter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Newsletter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Newsletter fields).
     */
    ...
    /**
     * Load a single Newsletter.
     *
     * @param NewsletterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NewsletterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Newsletter|array The loaded Newsletter as an assoc-array at the
    ...
    /**
     * List Newsletter items matching the given filter.
     *
     * @param NewsletterListMatch|array|null $reqmatch Match filter (any subset
     *   of Newsletter fields) as an assoc-array; NewsletterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Newsletter[]|array A list of Newsletter items as assoc-arrays at
     ...
     *
     * @param NewsletterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NewsletterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Newsletter|array The created Newsletter as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Newsletter matching the given criteria.
     *
     * @param NewsletterRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NewsletterRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Newsletter|array The removed Newsletter as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
