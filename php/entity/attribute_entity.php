...
class AttributeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AttributeEntity($this->_client, $opts);
    }

    /**
     * @param Attribute|array $args Attribute data (assoc-array) to store.
     */
    ...
    /**
     * @return Attribute|array The current Attribute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Attribute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Attribute fields).
     */
