...
class ExportEntity
{
     ...
     * Create a new Export.
     *
     * @param ExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Export|array The created Export as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
