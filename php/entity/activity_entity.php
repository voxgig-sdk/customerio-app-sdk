...
// CustomerioApp SDK Activity entity
...
class ActivityEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActivityEntity($this->_client, $opts);
    }

    /**
     * @param Activity|array $args Activity data (assoc-array) to store.
     */
    ...
    /**
     * @return Activity|array The current Activity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Activity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Activity fields).
     */
    ...
    /**
     * List Activity items matching the given filter.
     *
     * @param ActivityListMatch|array|null $reqmatch Match filter (any subset
     *   of Activity fields) as an assoc-array; ActivityListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Activity[]|array A list of Activity items as assoc-arrays at
