...
class StartEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StartEntity($this->_client, $opts);
    }

    /**
     * @param Start|array $args Start data (assoc-array) to store.
     */
    ...
    /**
     * @return Start|array The current Start data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Start fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Start fields).
     */
