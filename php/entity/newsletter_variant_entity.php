...
// CustomerioApp SDK NewsletterVariant entity
...
class NewsletterVariantEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NewsletterVariantEntity($this->_client, $opts);
    }

    /**
     * @param NewsletterVariant|array $args NewsletterVariant data (assoc-array) to store.
     */
    ...
    /**
     * @return NewsletterVariant|array The current NewsletterVariant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NewsletterVariant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NewsletterVariant fields).
     */
    ...
    /**
     * Load a single NewsletterVariant.
     *
     * @param NewsletterVariantLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NewsletterVariantLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterVariant|array The loaded NewsletterVariant as an assoc-array at the
    ...
    /**
     * List NewsletterVariant items matching the given filter.
     *
     * @param NewsletterVariantListMatch|array|null $reqmatch Match filter (any subset
     *   of NewsletterVariant fields) as an assoc-array; NewsletterVariantListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterVariant[]|array A list of NewsletterVariant items as assoc-arrays at
    ...
    /**
     * Create a new NewsletterVariant.
     *
     * @param NewsletterVariantCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NewsletterVariantCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterVariant|array The created NewsletterVariant as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing NewsletterVariant.
     *
     * @param NewsletterVariantUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NewsletterVariantUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterVariant|array The updated NewsletterVariant as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an NewsletterVariant matching the given criteria.
     *
     * @param NewsletterVariantRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NewsletterVariantRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsletterVariant|array The removed NewsletterVariant as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
