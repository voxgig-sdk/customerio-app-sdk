...
// CustomerioApp SDK EspSuppression entity
...
class EspSuppressionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EspSuppressionEntity($this->_client, $opts);
    }

    /**
     * @param EspSuppression|array $args EspSuppression data (assoc-array) to store.
     */
    ...
    /**
     * @return EspSuppression|array The current EspSuppression data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EspSuppression fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EspSuppression fields).
     */
    ...
    /**
     * Load a single EspSuppression.
     *
     * @param EspSuppressionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EspSuppressionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EspSuppression|array The loaded EspSuppression as an assoc-array at the
    ...
    /**
     * Create a new EspSuppression.
     *
     * @param EspSuppressionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EspSuppressionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EspSuppression|array The created EspSuppression as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an EspSuppression matching the given criteria.
     *
     * @param EspSuppressionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EspSuppressionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EspSuppression|array The removed EspSuppression as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
