...
// CustomerioApp SDK SendMessage entity
...
class SendMessageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SendMessageEntity($this->_client, $opts);
    }

    /**
     * @param SendMessage|array $args SendMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return SendMessage|array The current SendMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SendMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SendMessage fields).
     */
     ...
     *
     * @param SendMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SendMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SendMessage|array The created SendMessage as an assoc-array at the
