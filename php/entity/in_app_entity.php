...
class InAppEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InAppEntity($this->_client, $opts);
    }

    /**
     * @param InApp|array $args InApp data (assoc-array) to store.
     */
    ...
    /**
     * @return InApp|array The current InApp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InApp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InApp fields).
     */
