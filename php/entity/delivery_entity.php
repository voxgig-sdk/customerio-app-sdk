...
class DeliveryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeliveryEntity($this->_client, $opts);
    }

    /**
     * @param Delivery|array $args Delivery data (assoc-array) to store.
     */
    ...
    /**
     * @return Delivery|array The current Delivery data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Delivery fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Delivery fields).
     */
