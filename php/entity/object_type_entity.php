...
class ObjectTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ObjectTypeEntity($this->_client, $opts);
    }

    /**
     * @param ObjectType|array $args ObjectType data (assoc-array) to store.
     */
    ...
    /**
     * @return ObjectType|array The current ObjectType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ObjectType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ObjectType fields).
     */
