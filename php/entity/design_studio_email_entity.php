...
// CustomerioApp SDK DesignStudioEmail entity
...
class DesignStudioEmailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "design_studio_email";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DesignStudioEmailEntity($this->_client, $opts);
    }

    /**
     * @param DesignStudioEmail|array $args DesignStudioEmail data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = CustomerioAppHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return DesignStudioEmail|array The current DesignStudioEmail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DesignStudioEmail fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = CustomerioAppHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of DesignStudioEmail fields).
     */
    ...
    /**
     * Load a single DesignStudioEmail.
     *
     * @param DesignStudioEmailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DesignStudioEmailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudioEmail|array The loaded DesignStudioEmail as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = CustomerioAppHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * List DesignStudioEmail items matching the given filter.
     *
     * @param DesignStudioEmailListMatch|array|null $reqmatch Match filter (any subset
     *   of DesignStudioEmail fields) as an assoc-array; DesignStudioEmailListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudioEmail[]|array A list of DesignStudioEmail items as assoc-arrays at
     *   the SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new DesignStudioEmail.
     *
     * @param DesignStudioEmailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DesignStudioEmailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudioEmail|array The created DesignStudioEmail as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing DesignStudioEmail.
     *
     * @param DesignStudioEmailUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DesignStudioEmailUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudioEmail|array The updated DesignStudioEmail as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an DesignStudioEmail matching the given criteria.
     *
     * @param DesignStudioEmailRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DesignStudioEmailRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudioEmail|array The removed DesignStudioEmail as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
