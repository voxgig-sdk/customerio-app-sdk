...
class InboxMessageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InboxMessageEntity($this->_client, $opts);
    }

    /**
     * @param InboxMessage|array $args InboxMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return InboxMessage|array The current InboxMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InboxMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InboxMessage fields).
     */
