...
// CustomerioApp SDK OptOut entity
...
class OptOutEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OptOutEntity($this->_client, $opts);
    }

    /**
     * @param OptOut|array $args OptOut data (assoc-array) to store.
     */
    ...
    /**
     * @return OptOut|array The current OptOut data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OptOut fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OptOut fields).
     */
    ...
    /**
     * List OptOut items matching the given filter.
     *
     * @param OptOutListMatch|array|null $reqmatch Match filter (any subset
     *   of OptOut fields) as an assoc-array; OptOutListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OptOut[]|array A list of OptOut items as assoc-arrays at
    ...
    /**
     * Update an existing OptOut.
     *
     * @param OptOutUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OptOutUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OptOut|array The updated OptOut as an assoc-array at the
