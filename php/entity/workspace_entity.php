...
// CustomerioApp SDK Workspace entity
...
class WorkspaceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkspaceEntity($this->_client, $opts);
    }

    /**
     * @param Workspace|array $args Workspace data (assoc-array) to store.
     */
    ...
    /**
     * @return Workspace|array The current Workspace data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Workspace fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Workspace fields).
     */
    ...
    /**
     * List Workspace items matching the given filter.
     *
     * @param WorkspaceListMatch|array|null $reqmatch Match filter (any subset
     *   of Workspace fields) as an assoc-array; WorkspaceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workspace[]|array A list of Workspace items as assoc-arrays at
