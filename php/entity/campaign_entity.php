...
class CampaignEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CampaignEntity($this->_client, $opts);
    }

    /**
     * @param Campaign|array $args Campaign data (assoc-array) to store.
     */
    ...
    /**
     * @return Campaign|array The current Campaign data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Campaign fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Campaign fields).
     */
