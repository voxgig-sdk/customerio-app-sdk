...
// CustomerioApp SDK Snippet entity
...
class SnippetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SnippetEntity($this->_client, $opts);
    }

    /**
     * @param Snippet|array $args Snippet data (assoc-array) to store.
     */
    ...
    /**
     * @return Snippet|array The current Snippet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Snippet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Snippet fields).
     */
    ...
    /**
     * List Snippet items matching the given filter.
     *
     * @param SnippetListMatch|array|null $reqmatch Match filter (any subset
     *   of Snippet fields) as an assoc-array; SnippetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Snippet[]|array A list of Snippet items as assoc-arrays at
     ...
     *
     * @param SnippetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SnippetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Snippet|array The created Snippet as an assoc-array at the
     ...
     *
     * @param SnippetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SnippetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Snippet|array The updated Snippet as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Snippet matching the given criteria.
     *
     * @param SnippetRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SnippetRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Snippet|array The removed Snippet as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
