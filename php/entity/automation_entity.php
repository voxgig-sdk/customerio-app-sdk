...
// CustomerioApp SDK Automation entity
...
class AutomationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AutomationEntity($this->_client, $opts);
    }

    /**
     * @param Automation|array $args Automation data (assoc-array) to store.
     */
    ...
    /**
     * @return Automation|array The current Automation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Automation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Automation fields).
     */
     ...
     *
     * @param AutomationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AutomationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Automation|array The loaded Automation as an assoc-array at the
    ...
    /**
     * List Automation items matching the given filter.
     *
     * @param AutomationListMatch|array|null $reqmatch Match filter (any subset
     *   of Automation fields) as an assoc-array; AutomationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Automation[]|array A list of Automation items as assoc-arrays at
     ...
     *
     * @param AutomationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AutomationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Automation|array The updated Automation as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
