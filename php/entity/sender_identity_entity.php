...
// CustomerioApp SDK SenderIdentity entity
...
class SenderIdentityEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SenderIdentityEntity($this->_client, $opts);
    }

    /**
     * @param SenderIdentity|array $args SenderIdentity data (assoc-array) to store.
     */
    ...
    /**
     * @return SenderIdentity|array The current SenderIdentity data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SenderIdentity fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SenderIdentity fields).
     */
    ...
    /**
     * Load a single SenderIdentity.
     *
     * @param SenderIdentityLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SenderIdentityLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SenderIdentity|array The loaded SenderIdentity as an assoc-array at the
    ...
    /**
     * List SenderIdentity items matching the given filter.
     *
     * @param SenderIdentityListMatch|array|null $reqmatch Match filter (any subset
     *   of SenderIdentity fields) as an assoc-array; SenderIdentityListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SenderIdentity[]|array A list of SenderIdentity items as assoc-arrays at
