...
// CustomerioApp SDK DesignStudio entity
...
class DesignStudioEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DesignStudioEntity($this->_client, $opts);
    }

    /**
     * @param DesignStudio|array $args DesignStudio data (assoc-array) to store.
     */
    ...
    /**
     * @return DesignStudio|array The current DesignStudio data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DesignStudio fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DesignStudio fields).
     */
    ...
    /**
     * Load a single DesignStudio.
     *
     * @param DesignStudioLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DesignStudioLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudio|array The loaded DesignStudio as an assoc-array at the
    ...
    /**
     * List DesignStudio items matching the given filter.
     *
     * @param DesignStudioListMatch|array|null $reqmatch Match filter (any subset
     *   of DesignStudio fields) as an assoc-array; DesignStudioListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudio[]|array A list of DesignStudio items as assoc-arrays at
    ...
    /**
     * Create a new DesignStudio.
     *
     * @param DesignStudioCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DesignStudioCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudio|array The created DesignStudio as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing DesignStudio.
     *
     * @param DesignStudioUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DesignStudioUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudio|array The updated DesignStudio as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an DesignStudio matching the given criteria.
     *
     * @param DesignStudioRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DesignStudioRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DesignStudio|array The removed DesignStudio as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
