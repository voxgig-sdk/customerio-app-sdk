...
class TestGroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TestGroupEntity($this->_client, $opts);
    }

    /**
     * @param TestGroup|array $args TestGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return TestGroup|array The current TestGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TestGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TestGroup fields).
     */
