...
// CustomerioApp SDK Transactional entity
...
class TransactionalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransactionalEntity($this->_client, $opts);
    }

    /**
     * @param Transactional|array $args Transactional data (assoc-array) to store.
     */
    ...
    /**
     * @return Transactional|array The current Transactional data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Transactional fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Transactional fields).
     */
    ...
    /**
     * Load a single Transactional.
     *
     * @param TransactionalLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TransactionalLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transactional|array The loaded Transactional as an assoc-array at the
    ...
    /**
     * List Transactional items matching the given filter.
     *
     * @param TransactionalListMatch|array|null $reqmatch Match filter (any subset
     *   of Transactional fields) as an assoc-array; TransactionalListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transactional[]|array A list of Transactional items as assoc-arrays at
    ...
    /**
     * Update an existing Transactional.
     *
     * @param TransactionalUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionalUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transactional|array The updated Transactional as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
