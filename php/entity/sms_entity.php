...
class SmsEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SmsEntity($this->_client, $opts);
    }

    /**
     * @param Sms|array $args Sms data (assoc-array) to store.
     */
    ...
    /**
     * @return Sms|array The current Sms data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sms fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sms fields).
     */
