...
class InfoEntity
{
     ...
     *
     * @param InfoListMatch|array|null $reqmatch Match filter (any subset
     *   of Info fields) as an assoc-array; InfoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Info[]|array A list of Info items as assoc-arrays at
