...
// CustomerioApp SDK SubscriptionCenter entity
...
class SubscriptionCenterEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "subscription_center";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionCenterEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionCenter|array $args SubscriptionCenter data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionCenter|array The current SubscriptionCenter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionCenter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionCenter fields).
     */
    ...
    /**
     * Load a single SubscriptionCenter.
     *
     * @param SubscriptionCenterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SubscriptionCenterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionCenter|array The loaded SubscriptionCenter as an assoc-array at the
    ...
    /**
     * List SubscriptionCenter items matching the given filter.
     *
     * @param SubscriptionCenterListMatch|array|null $reqmatch Match filter (any subset
     *   of SubscriptionCenter fields) as an assoc-array; SubscriptionCenterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionCenter[]|array A list of SubscriptionCenter items as assoc-arrays at
