...
class RelationshipEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RelationshipEntity($this->_client, $opts);
    }

    /**
     * @param Relationship|array $args Relationship data (assoc-array) to store.
     */
    ...
    /**
     * @return Relationship|array The current Relationship data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Relationship fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Relationship fields).
     */
