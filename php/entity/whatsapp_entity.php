...
class WhatsappEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WhatsappEntity($this->_client, $opts);
    }

    /**
     * @param Whatsapp|array $args Whatsapp data (assoc-array) to store.
     */
    ...
    /**
     * @return Whatsapp|array The current Whatsapp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Whatsapp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Whatsapp fields).
     */
