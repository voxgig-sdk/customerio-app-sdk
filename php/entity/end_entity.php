...
class EndEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EndEntity($this->_client, $opts);
    }

    /**
     * @param End|array $args End data (assoc-array) to store.
     */
    ...
    /**
     * @return End|array The current End data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of End fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of End fields).
     */
