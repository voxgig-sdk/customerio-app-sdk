...
class SearchSuppressionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SearchSuppressionEntity($this->_client, $opts);
    }

    /**
     * @param SearchSuppression|array $args SearchSuppression data (assoc-array) to store.
     */
    ...
    /**
     * @return SearchSuppression|array The current SearchSuppression data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SearchSuppression fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SearchSuppression fields).
     */
