...
// CustomerioApp SDK Segment entity
...
class SegmentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SegmentEntity($this->_client, $opts);
    }

    /**
     * @param Segment|array $args Segment data (assoc-array) to store.
     */
    ...
    /**
     * @return Segment|array The current Segment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Segment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Segment fields).
     */
     ...
     *
     * @param SegmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SegmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Segment|array The loaded Segment as an assoc-array at the
    ...
    /**
     * List Segment items matching the given filter.
     *
     * @param SegmentListMatch|array|null $reqmatch Match filter (any subset
     *   of Segment fields) as an assoc-array; SegmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Segment[]|array A list of Segment items as assoc-arrays at
     ...
     *
     * @param SegmentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SegmentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Segment|array The created Segment as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Segment matching the given criteria.
     *
     * @param SegmentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SegmentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Segment|array The removed Segment as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
