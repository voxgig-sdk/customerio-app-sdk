...
class IpAddressEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IpAddressEntity($this->_client, $opts);
    }

    /**
     * @param IpAddress|array $args IpAddress data (assoc-array) to store.
     */
    ...
    /**
     * @return IpAddress|array The current IpAddress data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IpAddress fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IpAddress fields).
     */
