...
// CustomerioApp SDK ReportingWebhook entity
...
class ReportingWebhookEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportingWebhookEntity($this->_client, $opts);
    }

    /**
     * @param ReportingWebhook|array $args ReportingWebhook data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportingWebhook|array The current ReportingWebhook data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportingWebhook fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportingWebhook fields).
     */
    ...
    /**
     * Load a single ReportingWebhook.
     *
     * @param ReportingWebhookLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReportingWebhookLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingWebhook|array The loaded ReportingWebhook as an assoc-array at the
    ...
    /**
     * List ReportingWebhook items matching the given filter.
     *
     * @param ReportingWebhookListMatch|array|null $reqmatch Match filter (any subset
     *   of ReportingWebhook fields) as an assoc-array; ReportingWebhookListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingWebhook[]|array A list of ReportingWebhook items as assoc-arrays at
    ...
    /**
     * Create a new ReportingWebhook.
     *
     * @param ReportingWebhookCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReportingWebhookCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingWebhook|array The created ReportingWebhook as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ReportingWebhook.
     *
     * @param ReportingWebhookUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReportingWebhookUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingWebhook|array The updated ReportingWebhook as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ReportingWebhook matching the given criteria.
     *
     * @param ReportingWebhookRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ReportingWebhookRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingWebhook|array The removed ReportingWebhook as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
