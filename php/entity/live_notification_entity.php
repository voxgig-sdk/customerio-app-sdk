...
// CustomerioApp SDK LiveNotification entity
...
class LiveNotificationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LiveNotificationEntity($this->_client, $opts);
    }

    /**
     * @param LiveNotification|array $args LiveNotification data (assoc-array) to store.
     */
    ...
    /**
     * @return LiveNotification|array The current LiveNotification data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LiveNotification fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LiveNotification fields).
     */
    ...
    /**
     * Load a single LiveNotification.
     *
     * @param LiveNotificationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LiveNotificationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LiveNotification|array The loaded LiveNotification as an assoc-array at the
    ...
    /**
     * Create a new LiveNotification.
     *
     * @param LiveNotificationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LiveNotificationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LiveNotification|array The created LiveNotification as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
