...
class SubscriptionTopicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionTopicEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionTopic|array $args SubscriptionTopic data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionTopic|array The current SubscriptionTopic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionTopic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionTopic fields).
     */
