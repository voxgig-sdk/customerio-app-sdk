...
class TriggerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TriggerEntity($this->_client, $opts);
    }

    /**
     * @param Trigger|array $args Trigger data (assoc-array) to store.
     */
    ...
    /**
     * @return Trigger|array The current Trigger data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Trigger fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Trigger fields).
     */
