...
// CustomerioApp SDK Broadcast entity
...
class BroadcastEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BroadcastEntity($this->_client, $opts);
    }

    /**
     * @param Broadcast|array $args Broadcast data (assoc-array) to store.
     */
    ...
    /**
     * @return Broadcast|array The current Broadcast data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Broadcast fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Broadcast fields).
     */
     ...
     *
     * @param BroadcastLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BroadcastLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Broadcast|array The loaded Broadcast as an assoc-array at the
    ...
    /**
     * List Broadcast items matching the given filter.
     *
     * @param BroadcastListMatch|array|null $reqmatch Match filter (any subset
     *   of Broadcast fields) as an assoc-array; BroadcastListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Broadcast[]|array A list of Broadcast items as assoc-arrays at
     ...
     *
     * @param BroadcastUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BroadcastUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Broadcast|array The updated Broadcast as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
