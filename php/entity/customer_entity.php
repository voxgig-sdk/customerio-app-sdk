...
// CustomerioApp SDK Customer entity
...
class CustomerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CustomerEntity($this->_client, $opts);
    }

    /**
     * @param Customer|array $args Customer data (assoc-array) to store.
     */
    ...
    /**
     * @return Customer|array The current Customer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Customer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Customer fields).
     */
     ...
     *
     * @param CustomerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Customer|array The loaded Customer as an assoc-array at the
    ...
    /**
     * List Customer items matching the given filter.
     *
     * @param CustomerListMatch|array|null $reqmatch Match filter (any subset
     *   of Customer fields) as an assoc-array; CustomerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Customer[]|array A list of Customer items as assoc-arrays at
     ...
     *
     * @param CustomerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Customer|array The created Customer as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
