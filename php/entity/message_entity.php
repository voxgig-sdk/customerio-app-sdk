...
// CustomerioApp SDK Message entity
...
class MessageEntity
{
     ...
     *
     * @param MessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Message|array The loaded Message as an assoc-array at the
    ...
    /**
     * List Message items matching the given filter.
     *
     * @param MessageListMatch|array|null $reqmatch Match filter (any subset
     *   of Message fields) as an assoc-array; MessageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Message[]|array A list of Message items as assoc-arrays at
