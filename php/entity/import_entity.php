...
// CustomerioApp SDK Import entity
...
class ImportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ImportEntity($this->_client, $opts);
    }

    /**
     * @param Import|array $args Import data (assoc-array) to store.
     */
    ...
    /**
     * @return Import|array The current Import data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Import fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Import fields).
     */
     ...
     *
     * @param ImportLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ImportLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Import|array The loaded Import as an assoc-array at the
     ...
     * Create a new Import.
     *
     * @param ImportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ImportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Import|array The created Import as an assoc-array at the
     *   SDK boundary; throws CustomerioAppError on failure (item-5 convention).
     */
