...
// CustomerioApp SDK DataIndex entity
...
class DataIndexEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataIndexEntity($this->_client, $opts);
    }

    /**
     * @param DataIndex|array $args DataIndex data (assoc-array) to store.
     */
    ...
    /**
     * @return DataIndex|array The current DataIndex data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataIndex fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataIndex fields).
     */
    ...
    /**
     * Create a new DataIndex.
     *
     * @param DataIndexCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataIndexCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataIndex|array The created DataIndex as an assoc-array at the
