...
class LanguageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LanguageEntity($this->_client, $opts);
    }

    /**
     * @param Language|array $args Language data (assoc-array) to store.
     */
    ...
    /**
     * @return Language|array The current Language data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Language fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Language fields).
     */
