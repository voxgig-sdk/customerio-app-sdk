...
// CustomerioApp SDK utility: fetcher

class CustomerioAppFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CustomerioAppSDK/1.0)';
    ...
    public static function call(CustomerioAppContext $ctx, string $fullurl, array $fetchdef): array
    {
