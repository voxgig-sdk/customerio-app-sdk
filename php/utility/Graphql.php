...
// CustomerioApp SDK utility: graphql
//
...
class CustomerioAppGraphql
{
    ...
    // equivalent.
    public static function body(CustomerioAppContext $ctx): mixed
    {
    ...
    public static function errors(CustomerioAppContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
