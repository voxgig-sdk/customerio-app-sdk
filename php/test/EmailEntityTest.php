...
class EmailEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CUSTOMERIO_APP_TEST_EMAIL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function email_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CUSTOMERIO_APP_TEST_EMAIL_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["CUSTOMERIO_APP_TEST_EMAIL_ENTID"]);
