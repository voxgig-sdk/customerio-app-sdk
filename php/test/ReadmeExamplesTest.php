...
// CustomerioApp SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CustomerioAppSDK::test)
...
{
    private const SDK_CLASS = 'CustomerioAppSDK';
    ...
    private const SDK_BASE = 'customerioapp_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../customerioapp_sdk.php';
