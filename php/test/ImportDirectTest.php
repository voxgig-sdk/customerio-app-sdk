...
class ImportDirectTest extends TestCase
{
    public function test_direct_load_import(): void
    {
        $setup = import_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-import", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function import_direct_setup($mockres)
{
