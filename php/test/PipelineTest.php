...
// CustomerioApp SDK pipeline test
//
...
{
    private static function utility(): CustomerioAppUtility
    {
        return new CustomerioAppUtility();
    }
    ...
    private static function ctx(array $over = []): CustomerioAppContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CustomerioAppContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CustomerioAppOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CustomerioAppError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CustomerioAppOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CustomerioAppMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CustomerioAppOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CustomerioAppMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CustomerioAppOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CustomerioAppMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomerioAppSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CustomerioAppMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CustomerioAppResponse([]),
            'result' => new CustomerioAppResult([]),
        ]);
        [, $err] = CustomerioAppMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CustomerioAppSpec([]),
            'response' => null,
            'result' => new CustomerioAppResult([]),
        ]);
        [, $err] = CustomerioAppMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CustomerioAppSpec(['step' => 's']),
            'response' => new CustomerioAppResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CustomerioAppResult([]),
        ]);
        [, $err] = CustomerioAppMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomerioAppSpec(['step' => 's']),
            'response' => new CustomerioAppResponse(self::resp(200, ['v' => 1])),
            'result' => new CustomerioAppResult([]),
        ]);
        [, $err] = CustomerioAppMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CustomerioAppSpec(['step' => 's']),
            'response' => new CustomerioAppResponse(self::resp(200, ['v' => 2])),
            'result' => new CustomerioAppResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CustomerioAppMakeResponse::call($ctx);
    ...
    {
        $preset = new CustomerioAppResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CustomerioAppSpec([]),
            'response' => new CustomerioAppResponse([]),
            'result' => new CustomerioAppResult([]),
        ...
        [$got, $err] = CustomerioAppMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CustomerioAppResult([])]);
        [, $err] = CustomerioAppMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CustomerioAppSpec([]), 'result' => null]);
        [, $err] = CustomerioAppMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomerioAppSpec(['step' => 's']),
            'result' => new CustomerioAppResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CustomerioAppOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomerioAppMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CustomerioAppSpec(['step' => 's']),
            'result' => new CustomerioAppResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CustomerioAppOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CustomerioAppMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CustomerioAppResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CustomerioAppSpec([]),
            'result' => new CustomerioAppResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CustomerioAppMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomerioAppMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CustomerioAppError('boom', 'boom');
        $utility->fetcher = function (CustomerioAppContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomerioAppSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CustomerioAppMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CustomerioAppContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CustomerioAppMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CustomerioAppResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CustomerioAppMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CustomerioAppContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CustomerioAppSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CustomerioAppMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CustomerioAppResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CustomerioAppSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CustomerioAppMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CustomerioAppMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CustomerioAppMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CustomerioAppResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CustomerioAppDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CustomerioAppResult(['ok' => false])]);
        $this->expectException(CustomerioAppError::class);
        CustomerioAppDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CustomerioAppResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CustomerioAppMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CustomerioAppMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CustomerioAppBaseFeature();
        $b = new CustomerioAppBaseFeature();
        CustomerioAppFeatureAdd::call($ctx, $a);
        CustomerioAppFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CustomerioAppBaseFeature
    {
        $f = new CustomerioAppBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CustomerioAppFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CustomerioAppContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CustomerioAppSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CustomerioAppPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CustomerioAppPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CustomerioAppResponse(['headers' => null]),
            'result' => new CustomerioAppResult([]),
        ]);
        CustomerioAppResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CustomerioAppResultBody::call($ctx);
