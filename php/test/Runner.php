...
class CustomerioAppTestRunner
{
    ...
    {
        $live = self::getenv('CUSTOMERIO_APP_TEST_LIVE');
        $override = self::getenv('CUSTOMERIO_APP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CUSTOMERIO_APP_TEST_EXPLAIN');
...
class_alias('CustomerioAppTestRunner', 'Runner');
class_alias('CustomerioAppHelpers', 'Helpers');
