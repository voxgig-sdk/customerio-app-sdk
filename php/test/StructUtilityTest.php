...
// CustomerioApp SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CustomerioAppOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CustomerioAppOmni::structfix($now, Struct::undef()))
                        !== json_encode(CustomerioAppOmni::structfix($val, Struct::undef()))) {
