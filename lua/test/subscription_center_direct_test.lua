...
describe("SubscriptionCenterDirect", function()
  it("should direct-list-subscription_center", function()
    local setup = subscription_center_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-subscription_center", setup.live and "live" or "unit")
  ...
  it("should direct-load-subscription_center", function()
    local setup = subscription_center_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-subscription_center", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
