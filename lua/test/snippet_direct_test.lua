...
describe("SnippetDirect", function()
  it("should direct-list-snippet", function()
    local setup = snippet_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-snippet", setup.live and "live" or "unit")
