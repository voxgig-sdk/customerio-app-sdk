...
describe("CustomerEntity", function()
  it("should create instance", function()
    ...
    local ent = testsdk:Customer(nil)
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Customer(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Customer(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CUSTOMERIO_APP_TEST_CUSTOMER_ENTID JSON to run live")
      return
    end
...
function customer_basic_setup(extra)
  ...
  local entity_data_file = _test_dir .. "../../.sdk/test/entity/customer/CustomerTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read customer test data: " .. entity_data_file)
  end
  ...
  local entid_env_raw = os.getenv("CUSTOMERIO_APP_TEST_CUSTOMER_ENTID")
