...
function runner.env_override(m)
  local live = runner.getenv("CUSTOMERIO_APP_TEST_LIVE")
  local override = runner.getenv("CUSTOMERIO_APP_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CUSTOMERIO_APP_TEST_EXPLAIN")
