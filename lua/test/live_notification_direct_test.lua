...
describe("LiveNotificationDirect", function()
  it("should direct-load-live_notification", function()
    local setup = live_notification_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-live_notification", setup.live and "live" or "unit")
