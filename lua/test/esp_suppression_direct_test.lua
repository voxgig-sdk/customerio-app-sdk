...
describe("EspSuppressionDirect", function()
  it("should direct-load-esp_suppression", function()
    local setup = esp_suppression_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-esp_suppression", setup.live and "live" or "unit")
