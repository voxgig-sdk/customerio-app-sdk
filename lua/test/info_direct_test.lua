...
describe("InfoDirect", function()
  it("should direct-list-info", function()
    local setup = info_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-info", setup.live and "live" or "unit")
