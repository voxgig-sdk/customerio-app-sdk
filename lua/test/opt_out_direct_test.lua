...
describe("OptOutDirect", function()
  it("should direct-list-opt_out", function()
    local setup = opt_out_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-opt_out", setup.live and "live" or "unit")
