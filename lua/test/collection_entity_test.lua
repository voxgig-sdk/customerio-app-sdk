...
describe("CollectionEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set CUSTOMERIO_APP_TEST_COLLECTION_ENTID JSON to run live")
      return
    end
    ...
    local collection_ref01_markdef_up0_name = "name"
...
function collection_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("CUSTOMERIO_APP_TEST_COLLECTION_ENTID")
