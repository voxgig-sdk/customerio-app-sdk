...
describe("ImportDirect", function()
  it("should direct-load-import", function()
    local setup = import_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-import", setup.live and "live" or "unit")
