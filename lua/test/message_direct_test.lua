...
describe("MessageDirect", function()
  it("should direct-list-message", function()
    local setup = message_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-message", setup.live and "live" or "unit")
