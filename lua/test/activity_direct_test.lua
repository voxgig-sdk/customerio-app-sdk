...
describe("ActivityDirect", function()
  it("should direct-list-activity", function()
    local setup = activity_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-activity", setup.live and "live" or "unit")
