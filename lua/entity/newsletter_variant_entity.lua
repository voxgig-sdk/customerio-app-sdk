...
local NewsletterVariantEntity = {}
NewsletterVariantEntity.__index = NewsletterVariantEntity


function NewsletterVariantEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NewsletterVariantEntity)
  self._name = "newsletter_variant"
  self._client = client
...
function NewsletterVariantEntity:get_name()
  return self._name
end


function NewsletterVariantEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NewsletterVariantEntity.new(self._client, opts)
end
...
function NewsletterVariantEntity:mark_deleted()
  self._deleted = true
end


function NewsletterVariantEntity:deleted()
  return true == self._deleted
end


function NewsletterVariantEntity:data_set(args)
  if args ~= nil then
...
function NewsletterVariantEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NewsletterVariantEntity:match_set(args)
  if args ~= nil then
...
function NewsletterVariantEntity:match_get()
...
function NewsletterVariantEntity:stream(action, args, callopts)
...
---@param reqmatch NewsletterVariantLoadMatch
---@param ctrl? table
---@return NewsletterVariant
---@return string? err
function NewsletterVariantEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NewsletterVariantListMatch
---@param ctrl? table
---@return NewsletterVariant[]
---@return string? err
function NewsletterVariantEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata NewsletterVariantCreateData
---@param ctrl? table
---@return NewsletterVariant
---@return string? err
function NewsletterVariantEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata NewsletterVariantUpdateData
---@param ctrl? table
---@return NewsletterVariant
---@return string? err
function NewsletterVariantEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch NewsletterVariantRemoveMatch
---@param ctrl? table
---@return NewsletterVariant
---@return string? err
function NewsletterVariantEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function NewsletterVariantEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return NewsletterVariantEntity
