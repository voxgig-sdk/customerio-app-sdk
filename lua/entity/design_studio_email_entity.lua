...
local DesignStudioEmailEntity = {}
DesignStudioEmailEntity.__index = DesignStudioEmailEntity


function DesignStudioEmailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DesignStudioEmailEntity)
  self._name = "design_studio_email"
  self._client = client
...
function DesignStudioEmailEntity:get_name()
  return self._name
end


function DesignStudioEmailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DesignStudioEmailEntity.new(self._client, opts)
end
...
function DesignStudioEmailEntity:mark_deleted()
  self._deleted = true
end


function DesignStudioEmailEntity:deleted()
  return true == self._deleted
end


function DesignStudioEmailEntity:data_set(args)
  if args ~= nil then
...
function DesignStudioEmailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DesignStudioEmailEntity:match_set(args)
  if args ~= nil then
...
function DesignStudioEmailEntity:match_get()
...
function DesignStudioEmailEntity:stream(action, args, callopts)
...
---@param reqmatch DesignStudioEmailLoadMatch
---@param ctrl? table
---@return DesignStudioEmail
---@return string? err
function DesignStudioEmailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DesignStudioEmailListMatch
---@param ctrl? table
---@return DesignStudioEmail[]
---@return string? err
function DesignStudioEmailEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DesignStudioEmailCreateData
---@param ctrl? table
---@return DesignStudioEmail
---@return string? err
function DesignStudioEmailEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DesignStudioEmailUpdateData
---@param ctrl? table
---@return DesignStudioEmail
---@return string? err
function DesignStudioEmailEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DesignStudioEmailRemoveMatch
---@param ctrl? table
---@return DesignStudioEmail
---@return string? err
function DesignStudioEmailEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DesignStudioEmailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DesignStudioEmailEntity
