...
local DataIndexEntity = {}
DataIndexEntity.__index = DataIndexEntity


function DataIndexEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DataIndexEntity)
  self._name = "data_index"
  self._client = client
...
function DataIndexEntity:get_name()
  return self._name
end


function DataIndexEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DataIndexEntity.new(self._client, opts)
end
...
function DataIndexEntity:mark_deleted()
  self._deleted = true
end


function DataIndexEntity:deleted()
  return true == self._deleted
end


function DataIndexEntity:data_set(args)
  if args ~= nil then
...
function DataIndexEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DataIndexEntity:match_set(args)
  if args ~= nil then
...
function DataIndexEntity:match_get()
...
function DataIndexEntity:stream(action, args, callopts)
...
---@param reqdata DataIndexCreateData
---@param ctrl? table
---@return DataIndex
---@return string? err
function DataIndexEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DataIndexEntity:_run_op(ctx, post_done)
  local utility = self._utility
