-- CustomerioApp SDK SubscriptionChannel entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionChannelEntity = {}
SubscriptionChannelEntity.__index = SubscriptionChannelEntity


function SubscriptionChannelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionChannelEntity)
  self._name = "subscription_channel"
  self._client = client
...
function SubscriptionChannelEntity:get_name()
  return self._name
end


function SubscriptionChannelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionChannelEntity.new(self._client, opts)
end
...
function SubscriptionChannelEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionChannelEntity:deleted()
  return true == self._deleted
end


function SubscriptionChannelEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionChannelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionChannelEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionChannelEntity:match_get()
...
function SubscriptionChannelEntity:stream(action, args, callopts)
...
function SubscriptionChannelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionChannelEntity
