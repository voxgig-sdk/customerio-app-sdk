...
local BroadcastEntity = {}
BroadcastEntity.__index = BroadcastEntity


function BroadcastEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BroadcastEntity)
...
function BroadcastEntity:get_name()
  return self._name
end


function BroadcastEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BroadcastEntity.new(self._client, opts)
end
...
function BroadcastEntity:mark_deleted()
  self._deleted = true
end


function BroadcastEntity:deleted()
  return true == self._deleted
end


function BroadcastEntity:data_set(args)
  if args ~= nil then
...
function BroadcastEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BroadcastEntity:match_set(args)
  if args ~= nil then
...
function BroadcastEntity:match_get()
...
function BroadcastEntity:stream(action, args, callopts)
...
---@param reqmatch BroadcastLoadMatch
---@param ctrl? table
---@return Broadcast
---@return string? err
function BroadcastEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch BroadcastListMatch
---@param ctrl? table
---@return Broadcast[]
---@return string? err
function BroadcastEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata BroadcastUpdateData
---@param ctrl? table
---@return Broadcast
---@return string? err
function BroadcastEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function BroadcastEntity:_run_op(ctx, post_done)
  local utility = self._utility
