...
local SubscriptionCenterEntity = {}
SubscriptionCenterEntity.__index = SubscriptionCenterEntity


function SubscriptionCenterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionCenterEntity)
  self._name = "subscription_center"
  self._client = client
...
function SubscriptionCenterEntity:get_name()
  return self._name
end


function SubscriptionCenterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionCenterEntity.new(self._client, opts)
end
...
function SubscriptionCenterEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionCenterEntity:deleted()
  return true == self._deleted
end


function SubscriptionCenterEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionCenterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionCenterEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionCenterEntity:match_get()
...
function SubscriptionCenterEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionCenterLoadMatch
---@param ctrl? table
---@return SubscriptionCenter
---@return string? err
function SubscriptionCenterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SubscriptionCenterListMatch
---@param ctrl? table
---@return SubscriptionCenter[]
---@return string? err
function SubscriptionCenterEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function SubscriptionCenterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionCenterEntity
