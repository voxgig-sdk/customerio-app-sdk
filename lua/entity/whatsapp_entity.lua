-- CustomerioApp SDK Whatsapp entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local WhatsappEntity = {}
WhatsappEntity.__index = WhatsappEntity


function WhatsappEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WhatsappEntity)
  self._name = "whatsapp"
  self._client = client
...
function WhatsappEntity:get_name()
  return self._name
end


function WhatsappEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WhatsappEntity.new(self._client, opts)
end
...
function WhatsappEntity:mark_deleted()
  self._deleted = true
end


function WhatsappEntity:deleted()
  return true == self._deleted
end


function WhatsappEntity:data_set(args)
  if args ~= nil then
...
function WhatsappEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WhatsappEntity:match_set(args)
  if args ~= nil then
...
function WhatsappEntity:match_get()
...
function WhatsappEntity:stream(action, args, callopts)
...
function WhatsappEntity:_run_op(ctx, post_done)
  local utility = self._utility
