-- CustomerioApp SDK SubscriptionTopic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionTopicEntity = {}
SubscriptionTopicEntity.__index = SubscriptionTopicEntity


function SubscriptionTopicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionTopicEntity)
  self._name = "subscription_topic"
  self._client = client
...
function SubscriptionTopicEntity:get_name()
  return self._name
end


function SubscriptionTopicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionTopicEntity.new(self._client, opts)
end
...
function SubscriptionTopicEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionTopicEntity:deleted()
  return true == self._deleted
end


function SubscriptionTopicEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionTopicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionTopicEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionTopicEntity:match_get()
...
function SubscriptionTopicEntity:stream(action, args, callopts)
...
function SubscriptionTopicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SubscriptionTopicEntity
