...
local NewsletterEntity = {}
NewsletterEntity.__index = NewsletterEntity


function NewsletterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NewsletterEntity)
  self._name = "newsletter"
  self._client = client
...
function NewsletterEntity:get_name()
  return self._name
end


function NewsletterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NewsletterEntity.new(self._client, opts)
end
...
function NewsletterEntity:mark_deleted()
  self._deleted = true
end


function NewsletterEntity:deleted()
  return true == self._deleted
end


function NewsletterEntity:data_set(args)
  if args ~= nil then
...
function NewsletterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NewsletterEntity:match_set(args)
  if args ~= nil then
...
function NewsletterEntity:match_get()
...
function NewsletterEntity:stream(action, args, callopts)
...
---@param reqmatch NewsletterLoadMatch
---@param ctrl? table
---@return Newsletter
---@return string? err
function NewsletterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NewsletterListMatch
---@param ctrl? table
---@return Newsletter[]
---@return string? err
function NewsletterEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata NewsletterCreateData
---@param ctrl? table
---@return Newsletter
---@return string? err
function NewsletterEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch NewsletterRemoveMatch
---@param ctrl? table
---@return Newsletter
---@return string? err
function NewsletterEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function NewsletterEntity:_run_op(ctx, post_done)
  local utility = self._utility
