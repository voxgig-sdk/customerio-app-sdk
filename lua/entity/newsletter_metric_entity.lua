...
local NewsletterMetricEntity = {}
NewsletterMetricEntity.__index = NewsletterMetricEntity


function NewsletterMetricEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NewsletterMetricEntity)
  self._name = "newsletter_metric"
  self._client = client
...
function NewsletterMetricEntity:get_name()
  return self._name
end


function NewsletterMetricEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NewsletterMetricEntity.new(self._client, opts)
end
...
function NewsletterMetricEntity:mark_deleted()
  self._deleted = true
end


function NewsletterMetricEntity:deleted()
  return true == self._deleted
end


function NewsletterMetricEntity:data_set(args)
  if args ~= nil then
...
function NewsletterMetricEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NewsletterMetricEntity:match_set(args)
  if args ~= nil then
...
function NewsletterMetricEntity:match_get()
...
function NewsletterMetricEntity:stream(action, args, callopts)
...
---@param reqmatch NewsletterMetricLoadMatch
---@param ctrl? table
---@return NewsletterMetric
---@return string? err
function NewsletterMetricEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NewsletterMetricListMatch
---@param ctrl? table
---@return NewsletterMetric[]
---@return string? err
function NewsletterMetricEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function NewsletterMetricEntity:_run_op(ctx, post_done)
  local utility = self._utility
