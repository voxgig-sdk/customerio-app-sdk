...
local ReportingWebhookEntity = {}
ReportingWebhookEntity.__index = ReportingWebhookEntity


function ReportingWebhookEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ReportingWebhookEntity)
  self._name = "reporting_webhook"
  self._client = client
...
function ReportingWebhookEntity:get_name()
  return self._name
end


function ReportingWebhookEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ReportingWebhookEntity.new(self._client, opts)
end
...
function ReportingWebhookEntity:mark_deleted()
  self._deleted = true
end


function ReportingWebhookEntity:deleted()
  return true == self._deleted
end


function ReportingWebhookEntity:data_set(args)
  if args ~= nil then
...
function ReportingWebhookEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ReportingWebhookEntity:match_set(args)
  if args ~= nil then
...
function ReportingWebhookEntity:match_get()
...
function ReportingWebhookEntity:stream(action, args, callopts)
...
---@param reqmatch ReportingWebhookLoadMatch
---@param ctrl? table
---@return ReportingWebhook
---@return string? err
function ReportingWebhookEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ReportingWebhookListMatch
---@param ctrl? table
---@return ReportingWebhook[]
---@return string? err
function ReportingWebhookEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ReportingWebhookCreateData
---@param ctrl? table
---@return ReportingWebhook
---@return string? err
function ReportingWebhookEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ReportingWebhookUpdateData
---@param ctrl? table
---@return ReportingWebhook
---@return string? err
function ReportingWebhookEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ReportingWebhookRemoveMatch
---@param ctrl? table
---@return ReportingWebhook
---@return string? err
function ReportingWebhookEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ReportingWebhookEntity:_run_op(ctx, post_done)
  local utility = self._utility
