-- CustomerioApp SDK Delivery entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DeliveryEntity = {}
DeliveryEntity.__index = DeliveryEntity


function DeliveryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeliveryEntity)
  self._name = "delivery"
  self._client = client
...
function DeliveryEntity:get_name()
  return self._name
end


function DeliveryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeliveryEntity.new(self._client, opts)
end
...
function DeliveryEntity:mark_deleted()
  self._deleted = true
end


function DeliveryEntity:deleted()
  return true == self._deleted
end


function DeliveryEntity:data_set(args)
  if args ~= nil then
...
function DeliveryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeliveryEntity:match_set(args)
  if args ~= nil then
...
function DeliveryEntity:match_get()
...
function DeliveryEntity:stream(action, args, callopts)
...
function DeliveryEntity:_run_op(ctx, post_done)
  local utility = self._utility
