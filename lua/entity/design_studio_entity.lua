...
local DesignStudioEntity = {}
DesignStudioEntity.__index = DesignStudioEntity


function DesignStudioEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DesignStudioEntity)
  self._name = "design_studio"
  self._client = client
...
function DesignStudioEntity:get_name()
  return self._name
end


function DesignStudioEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DesignStudioEntity.new(self._client, opts)
end
...
function DesignStudioEntity:mark_deleted()
  self._deleted = true
end


function DesignStudioEntity:deleted()
  return true == self._deleted
end


function DesignStudioEntity:data_set(args)
  if args ~= nil then
...
function DesignStudioEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DesignStudioEntity:match_set(args)
  if args ~= nil then
...
function DesignStudioEntity:match_get()
...
function DesignStudioEntity:stream(action, args, callopts)
...
---@param reqmatch DesignStudioLoadMatch
---@param ctrl? table
---@return DesignStudio
---@return string? err
function DesignStudioEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DesignStudioListMatch
---@param ctrl? table
---@return DesignStudio[]
---@return string? err
function DesignStudioEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DesignStudioCreateData
---@param ctrl? table
---@return DesignStudio
---@return string? err
function DesignStudioEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DesignStudioUpdateData
---@param ctrl? table
---@return DesignStudio
---@return string? err
function DesignStudioEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DesignStudioRemoveMatch
---@param ctrl? table
---@return DesignStudio
---@return string? err
function DesignStudioEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DesignStudioEntity:_run_op(ctx, post_done)
  local utility = self._utility
