...
|---|---|---|
| `js/` | @voxgig-sdk/customerio-app-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/customerio-app | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/customerio-app-js \
      --repository voxgig-sdk/customerio-app-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/customerio-app-js` shows it, and
`npm trust revoke @voxgig-sdk/customerio-app-js --id=<id>` removes it.
