...
class CustomerioAppTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CustomerioAppTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CustomerioAppTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CustomerioAppTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
