...
// CustomerioApp SDK utility: make_options

class CustomerioAppMakeOptions
{
    ...
    public static function call(CustomerioAppContext $ctx): array
    {
        ...
        //
        // `CustomerioAppSchema::optspec()` is built from the model:
        ...
        $optspec = CustomerioAppSchema::optspec();
