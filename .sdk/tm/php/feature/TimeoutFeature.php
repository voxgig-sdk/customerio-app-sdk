...
// CustomerioApp SDK timeout feature
...
class CustomerioAppTimeoutFeature extends CustomerioAppBaseFeature
{
    ...
    private function _with_timeout(CustomerioAppContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CustomerioAppContext $_ctx, float $ms): void
    {
        $client = $this->client;
