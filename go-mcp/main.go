// Command CustomerioApp-mcp is an MCP server exposing the CustomerioApp
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CustomerioApp_list  — list records of an entity
//	CustomerioApp_load  — load a single record of an entity
//
